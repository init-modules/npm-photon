...
// src/i18n/use-photon-translation-completeness.ts
import { useCallback, useMemo, useState } from "react";
var usePhotonTranslationCompleteness = ({
  locales,
  referenceLocale,
...
// src/studio/inspector-panel/field-localization-marker.tsx
import { Languages, TriangleAlert } from "lucide-react";
import { jsx as jsx2 } from "react/jsx-runtime";
var PhotonFieldLocalizationMarker = ({
  block,
  schema,
  fieldPath,
  fieldKind,
  ...
  if (hasMissing && missingLocales) {
    const labels = missingLocales.map((code) => getLocaleLabel?.(code) ?? code.toUpperCase()).join(", ");
    return /* @__PURE__ */ jsx2(
      "span",
      {
        ...
        children: /* @__PURE__ */ jsx2(TriangleAlert, { className: "h-3 w-3" })
      }
    );
  }
  return /* @__PURE__ */ jsx2(
    "span",
    {
      "aria-label": isOverride ? "Translatable (explicit override)" : "Translatable",
      title: isOverride ? "This field is marked translatable on this instance (override)." : "This field is translated per locale.",
      ...
      children: /* @__PURE__ */ jsx2(Languages, { className: "h-3 w-3" })
    }
  );
};
...
import { memo, useEffect as useEffect2, useState as useState7 } from "react";
...
var DropdownMenuRadioItem = forwardRef2(({ className, children, ...props }, ref) => {
  return /* @__PURE__ */ jsxs2(
    DropdownMenuPrimitive2.RadioItem,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx4("span", { className: "absolute right-3 inline-flex h-4 w-4 items-center justify-center", children: /* @__PURE__ */ jsx4(DropdownMenuPrimitive2.ItemIndicator, { children: /* @__PURE__ */ jsx4(
          Check,
          {
            className: "h-4 w-4",
...
var PhotonInspectorDensityProvider = ({
  ...
  return /* @__PURE__ */ jsx5(PhotonInspectorDensityContext.Provider, { value, children });
};
...
var PhotonFormFieldsEditor = ({
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsx9("div", { className: "space-y-2 rounded-[20px] border border-[color:var(--photon-builder-border)] bg-[color:var(--photon-builder-panel-muted)] p-2", children: fields.map((field, index) => {
          ...
          children: [
            /* @__PURE__ */ jsxs3("div", { className: "flex items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxs3(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx9("div", { className: "truncate text-sm font-semibold text-[color:var(--photon-builder-text)]", children: field.label || field.id || "Field" }),
            ...
            isExpanded ? /* @__PURE__ */ jsxs3("div", { className: "mt-4 grid gap-3", children: [
              ...
              field.type === "select" ? /* @__PURE__ */ jsxs3("div", { className: "rounded-[16px] border border-[color:var(--photon-builder-border)] bg-[color:var(--photon-builder-panel-muted)] p-3", children: [
                /* @__PURE__ */ jsx9("div", { className: "mb-3 text-sm font-semibold text-[color:var(--photon-builder-text)]", children: "Options" }),
                /* @__PURE__ */ jsx9("div", { className: "grid gap-2", children: options.map((option, optionIndex) => /* @__PURE__ */ jsxs3(
                  "div",
                  {
...
var ContextMenuCheckboxItem = forwardRef3(({ className, children, checked, ...props }, ref) => {
  return /* @__PURE__ */ jsxs4(
    ContextMenuPrimitive.CheckboxItem,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx10("span", { className: "absolute left-3 inline-flex h-4 w-4 items-center justify-center", children: /* @__PURE__ */ jsx10(ContextMenuPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx10(
          Check2,
          {
            className: "h-4 w-4",
            style: { color: "var(--photon-builder-accent)" }
...
var ContextMenuContent = forwardRef4(({ className, ...props }, ref) => {
  return /* @__PURE__ */ jsx11(ContextMenuPrimitive2.Portal, { children: /* @__PURE__ */ jsx11(
...
// src/studio/inspector-panel/field-label-localization-menu.tsx
import { Fragment, jsx as jsx14, jsxs as jsxs5 } from "react/jsx-runtime";
var FieldLabelLocalizationMenu = ({
  block,
  schema,
  fieldPath,
  fieldKind,
  ...
  return /* @__PURE__ */ jsxs5(Root3, { children: [
    /* @__PURE__ */ jsx14(Trigger2, { asChild: true, children: /* @__PURE__ */ jsxs5("span", { className: "inline-flex items-center gap-1.5", children: [
      children,
      /* @__PURE__ */ jsx14(
    ...
    /* @__PURE__ */ jsxs5(ContextMenuContent, { children: [
      /* @__PURE__ */ jsx14(
        ContextMenuCheckboxItem,
        {
          ...
          children: "Translatable per locale"
        }
      ),
      /* @__PURE__ */ jsx14(
        ContextMenuCheckboxItem,
        {
          ...
          disabled: !onSetLocalization && !onToggle,
          children: "Shared across locales"
        }
      ),
      isOverride ? /* @__PURE__ */ jsxs5(Fragment, { children: [
        /* @__PURE__ */ jsx14(ContextMenuSeparator, {}),
        /* @__PURE__ */ jsx14(
          ContextMenuItem,
          {
...
var GalleryFieldEditor = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsx15("div", { className: "space-y-3", children: items.map((item, index) => /* @__PURE__ */ jsx15(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs6("div", { className: "grid gap-3 sm:grid-cols-[80px_minmax(0,1fr)]", children: [
          /* @__PURE__ */ jsx15(
            "div",
            {
              ...
              children: resolvePhotonMediaPreviewUrl(item.media) ? /* @__PURE__ */ jsx15(
                "img",
                {
          ...
          /* @__PURE__ */ jsxs6("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxs6("div", { className: "flex flex-wrap gap-2", children: [
              ...
              isPhotonMediaValue(item.media) && item.media.temporaryUploadId ? /* @__PURE__ */ jsx15(
                "div",
                {
                  className: "rounded-full border px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.22em]",
                  style: {
    ...
    /* @__PURE__ */ jsxs6(
      "label",
      {
        ...
        children: [
          /* @__PURE__ */ jsx15("span", { children: isUploading ? "Uploading..." : items.length > 0 ? "Add more media" : "Add media" }),
          /* @__PURE__ */ jsx15(
            "input",
            {
              type: "file",
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsx16(
      "div",
      {
        ...
        children: source ? /* @__PURE__ */ jsx16(
          "img",
          {
            src: source,
    ...
    mediaValue?.temporaryUploadId || mediaValue?.fileName || mediaValue?.size ? /* @__PURE__ */ jsxs7("div", { className: "flex flex-wrap gap-1", children: [
      mediaValue?.temporaryUploadId ? /* @__PURE__ */ jsx16(
        "div",
        {
      ...
      mediaValue?.fileName ? /* @__PURE__ */ jsx16(
        "div",
        {
          className: "rounded-sm px-1.5 py-0 text-[10px] uppercase tracking-[0.14em]",
          style: {
      ...
      mediaValue?.size ? /* @__PURE__ */ jsx16(
        "div",
        {
          className: "rounded-sm px-1.5 py-0 text-[10px] uppercase tracking-[0.14em]",
          style: {
    ...
    /* @__PURE__ */ jsxs7("div", { className: "flex items-center gap-1", children: [
      /* @__PURE__ */ jsxs7(
        "label",
        {
          ...
          children: [
            /* @__PURE__ */ jsx16("span", { children: isUploading ? "Uploading\u2026" : source ? "Replace" : "Upload" }),
            /* @__PURE__ */ jsx16(
              "input",
              {
                type: "file",
...
var JsonFieldEditor = ({
  ...
  return /* @__PURE__ */ jsxs8("div", { "data-testid": `photon-json-field-editor-${testIdSuffix}`, children: [
    /* @__PURE__ */ jsx17(
      "textarea",
      {
    ...
    /* @__PURE__ */ jsxs8("div", { className: "mt-3 flex items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxs8(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx17(WandSparkles, { className: "h-3.5 w-3.5" }),
            "Apply JSON"
          ]
        }
      ),
...
var SiteDataBindingPicker = (props) => {
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "relative inline-flex", children: [
    /* @__PURE__ */ jsx18(
      "button",
      {
        type: "button",
    ...
    isOpen && pendingPick ? /* @__PURE__ */ jsxs9(
      "div",
      {
        ...
        children: [
          ...
          adapterKeys.map((adapterKey) => /* @__PURE__ */ jsx18(
            "button",
            {
              type: "button",
              onClick: () => emitFieldBinding(
              ...
              children: /* @__PURE__ */ jsx18("span", { children: adapterKey })
            },
            adapterKey
          ))
        ]
    ...
    isOpen && !pendingPick ? /* @__PURE__ */ jsxs9(
      "div",
      {
        ...
        children: [
          siteData.schemas.map((schema) => /* @__PURE__ */ jsxs9("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ jsx18(
              "div",
              {
                className: "px-2 py-1 text-xs uppercase tracking-wide",
            ...
            schema.fields.map((field) => /* @__PURE__ */ jsxs9(
              "button",
              {
                type: "button",
                role: "menuitem",
                ...
                children: [
                  /* @__PURE__ */ jsx18("span", { children: field.label }),
                  /* @__PURE__ */ jsx18("code", { className: "text-xs", style: subtleStyle, children: `{{ ${schema.id}.${field.path} }}` })
                ]
              },
              `${schema.id}.${field.path}`
            ))
          ] }, schema.id)),
          routeContextFields.length > 0 ? /* @__PURE__ */ jsxs9("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ jsx18(
              "div",
              {
                className: "px-2 py-1 text-xs uppercase tracking-wide",
            ...
            routeContextFields.map((field) => /* @__PURE__ */ jsxs9(
              "button",
              {
                type: "button",
                role: "menuitem",
                ...
                children: [
                  /* @__PURE__ */ jsx18("span", { children: field.label }),
                  /* @__PURE__ */ jsx18("code", { className: "text-xs", style: subtleStyle, children: `{{ route.${field.path} }}` })
                ]
              },
              `route.${field.path}`
            ))
...
var SelectFieldEditor = ({
  ...
  const trigger = /* @__PURE__ */ jsxs10(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx19("span", { className: "min-w-0 truncate", children: translate(
          activeOption?.labelKey ?? activeOption?.label ?? "Select value",
          activeOption?.label ?? "Select value"
        ) }),
        /* @__PURE__ */ jsx19(ChevronDown, { className: "h-4 w-4 shrink-0 text-[color:var(--photon-builder-text-soft)]" })
      ]
    }
  );
  useEffect2(() => {
  ...
  return /* @__PURE__ */ jsxs10(Root2, { modal: false, children: [
    /* @__PURE__ */ jsx19(Trigger, { asChild: true, children: trigger }),
    /* @__PURE__ */ jsx19(DropdownMenuContent, { align: "start", className: "min-w-[14rem]", children: /* @__PURE__ */ jsx19(
      RadioGroup,
      {
        value: selectedValue,
        onValueChange: (nextValue) => onChange(nextValue),
        children: (field.options ?? []).map((option) => /* @__PURE__ */ jsx19(
...
var ObjectFieldEditor = ({
  ...
  return /* @__PURE__ */ jsx19("div", { className: "space-y-0.5 rounded-sm bg-[color:var(--photon-builder-field)] p-1", children: (field.fields ?? []).map((childField, index) => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs10("div", { className: "flex items-center justify-between gap-2", children: [
          ...
          /* @__PURE__ */ jsxs10("div", { className: "flex shrink-0 items-center gap-0.5", children: [
            /* @__PURE__ */ jsx19(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ jsx19(ArrowUp2, { className: "h-3 w-3" })
              }
            ),
            /* @__PURE__ */ jsx19(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx19(ArrowDown2, { className: "h-3 w-3" })
              }
            ),
            /* @__PURE__ */ jsx19(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx19(Trash22, { className: "h-3 w-3" })
              }
            )
          ] })
        ] }),
        collapsed ? null : /* @__PURE__ */ jsx19("div", { className: "mt-1", children })
      ]
    },
    itemAbsolutePath
  );
...
var RepeaterFieldEditor = ({
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsx19("div", { className: "space-y-1 rounded-sm bg-[color:var(--photon-builder-field)] p-1.5", children: items.map((item, index) => {
      ...
      return /* @__PURE__ */ jsx19(
        RepeaterItem,
        {
          ...
          children: itemField ? /* @__PURE__ */ jsx19(
            FieldEditor,
            {
              field: itemField,
              blockId,
          ...
          ) : /* @__PURE__ */ jsx19("div", { className: "space-y-0.5", children: (field.fields ?? []).map((childField, childIndex) => {
    ...
    /* @__PURE__ */ jsxs10(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx19(Plus2, { className: "h-3 w-3" }),
          translate(
...
var FieldEditorImpl = ({
  ...
  const handleSetLocalization = (target) => {
    if (!block) return;
    setBlockFieldLocalization(block.id, path, target);
    if (onUpdateBlock) {
      const next = {
  ...
  const baseLabel = /* @__PURE__ */ jsx19(
    "div",
    {
      className: clsx4(
  ...
  const localeLabelLookup = (code) => i18nContext.editableLocales.find((l) => l.code === code)?.label;
  const missingIndicatorsDisabled = usePhotonStore((state) => {
    const localesSettings = state.site.settings?.locales;
    return Boolean(localesSettings?.disableMissingTranslationIndicators);
  });
  const missingLocales = block && editableLocaleCodes.length > 1 && !missingIndicatorsDisabled ? findPhotonFieldMissingLocales({
    block,
  ...
  const labelNode = block ? /* @__PURE__ */ jsx19(
  ...
  const bindingPill = path && fieldBinding ? /* @__PURE__ */ jsxs10(
    "button",
    {
      type: "button",
      ...
      children: [
        /* @__PURE__ */ jsxs10("span", { children: [
          ...
          ":",
          fieldBinding.path,
          fieldBinding.adapter ? /* @__PURE__ */ jsxs10(
            "span",
            {
        ...
        /* @__PURE__ */ jsx19("span", { "data-testid": `photon-field-binding-unbind-${path}`, children: "\xD7" })
      ]
    }
  ) : null;
  const renderControl = () => {
  ...
  const description = field.description ? /* @__PURE__ */ jsx19(
    "div",
    {
    ...
    return /* @__PURE__ */ jsxs10(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs10("div", { className: "flex min-w-0 flex-1 items-center gap-1", children: [
            renderControl(),
            bindingPill,
            path && !fieldBinding ? /* @__PURE__ */ jsx19(
              SiteDataBindingPicker,
              {
                mode: "field",
                label: "\u2197",
          ...
          path && !hidePathLabel ? /* @__PURE__ */ jsx19(
            "button",
            {
              type: "button",
  ...
  if (isFlatField) {
    return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-1 px-1 py-1", "data-photon-density-row": true, children: [
      ...
      description ? /* @__PURE__ */ jsx19("div", { children: description }) : null,
      path && !fieldBinding ? /* @__PURE__ */ jsx19(
        SiteDataBindingPicker,
        {
          mode: "field",
  ...
  return /* @__PURE__ */ jsxs10(
    NonInlineFieldShell,
    {
      ...
      children: [
        path && !fieldBinding ? /* @__PURE__ */ jsx19("div", { className: "mb-1", children: /* @__PURE__ */ jsx19(
          SiteDataBindingPicker,
          {
            mode: "field",
            label: "Bind field",
...
var NonInlineFieldShell = ({
  ...
  return /* @__PURE__ */ jsxs10(
    ...
    {
      "data-photon-density-row": true,
      className: clsx4("overflow-hidden", tokens.sectionRadius),
      ...
      children: [
        ...
        isExpanded ? /* @__PURE__ */ jsxs10("div", { className: clsx4(tokens.sectionPadding, "pt-1"), children: [
          description ? /* @__PURE__ */ jsx19("div", { className: "mb-1", children: description }) : null,
          children
        ] }) : null
      ]
    }
...
var PhotonFieldEditorList = ({
  ...
  return /* @__PURE__ */ jsx20("div", { className: "space-y-4", children: fields.map((field) => /* @__PURE__ */ jsx20(
    "div",
    {
  ...
  return /* @__PURE__ */ jsxs11(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx21("div", { className: "mt-1", style: { color: "var(--photon-builder-text-muted)" }, children: "Move block into any visible insert zone." })
      ]
    }
  );
};
...
import { memo as memo2, useEffect as useEffect3, useState as useState8 } from "react";
...
var CanvasBlockShellComponent = ({
  ...
  const chromeBadges = builderEnabled ? /* @__PURE__ */ jsxs12(Fragment2, { children: [
    /* @__PURE__ */ jsx22(
      "div",
      {
  ...
  const chromeControls = chromeEnabled ? /* @__PURE__ */ jsxs12(Fragment2, { children: [
    /* @__PURE__ */ jsx22(
      "button",
      {
        type: "button",
        ...
        children: isCollapsed ? /* @__PURE__ */ jsx22(ChevronDown2, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx22(ChevronUp, { className: "h-4 w-4" })
      }
    ),
    builderEnabled ? /* @__PURE__ */ jsxs12(Fragment2, { children: [
      /* @__PURE__ */ jsx22(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsx22(Copy, { className: "h-4 w-4" })
        }
      ),
      /* @__PURE__ */ jsx22(
        "button",
      ...
      /* @__PURE__ */ jsx22(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsx22(GripVertical, { className: "h-4 w-4" })
        }
      )
    ] }) : null
  ] }) : null;
  if (edgeToEdgeChrome && chromeEnabled) {
    return /* @__PURE__ */ jsxs12(
      "article",
      {
        ...
        children: [
          chromeEnabled ? /* @__PURE__ */ jsxs12("div", { className: "mb-3 flex items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsx22("div", { className: "pointer-events-none flex min-h-10 max-w-[70%] flex-wrap items-center gap-2", children: chromeBadges }),
            /* @__PURE__ */ jsx22("div", { className: "relative z-10 flex shrink-0 items-center gap-2", children: chromeControls })
          ] }) : null,
          /* @__PURE__ */ jsx22(
            "div",
            {
  ...
  return /* @__PURE__ */ jsxs12(
    "article",
    {
      ...
      children: [
        ...
        builderEnabled ? /* @__PURE__ */ jsx22("div", { className: "pointer-events-none absolute left-5 top-5 z-10 flex max-w-[70%] flex-wrap items-center gap-2", children: chromeBadges }) : null,
        chromeEnabled ? /* @__PURE__ */ jsx22("div", { className: "absolute right-5 top-5 z-10 flex items-center gap-2", children: chromeControls }) : null,
        /* @__PURE__ */ jsx22(
          "div",
          {
            className: clsx5(
...
var InlineEditableText = ({
  ...
  if (select && options) {
    ...
    return /* @__PURE__ */ jsx23(
      "select",
      {
        ...
        children: options.map((opt) => /* @__PURE__ */ jsx23("option", { value: opt.value, children: opt.label }, opt.value))
      }
    );
  }
  ...
  if (editing) {
    ...
    return multiline ? /* @__PURE__ */ jsx23("textarea", { rows: 3, ...sharedProps }) : /* @__PURE__ */ jsx23("input", { type: "text", ...sharedProps });
  }
  ...
  return /* @__PURE__ */ jsxs13(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx23("span", { className: "flex-1 whitespace-pre-wrap", children: display }),
        /* @__PURE__ */ jsx23(
          Pencil,
          {
...
var TriggerStageSection = ({
  ...
  return /* @__PURE__ */ jsxs13(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs13("header", { className: "flex flex-wrap items-center gap-3", children: [
          /* @__PURE__ */ jsx23(
            "div",
            {
          ...
          scenarios.length ? /* @__PURE__ */ jsx23("div", { className: "flex flex-wrap gap-1.5", children: scenarios.map((scenario) => {
        ...
        /* @__PURE__ */ jsxs13("div", { className: "mb-3 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsx23(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx23(X, { className: "h-3 w-3" })
            }
          )
        ] }),
        /* @__PURE__ */ jsx23(TriggerStageSection, { slot: activeSlot, block })
      ]
    }
  );
};
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs14(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx24(Plus3, { className: "h-3.5 w-3.5" }),
  ...
  return /* @__PURE__ */ jsxs15(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx25("div", { className: "mt-2", style: { color: "var(--photon-builder-text-soft)" }, children: block.areas?.length ? `${block.areas.length} layout area${block.areas.length > 1 ? "s" : ""} hidden while collapsed.` : "Collapsed to keep the canvas compact while you work on neighboring sections." })
      ]
    }
  );
};
    ...
    children: [
      /* @__PURE__ */ jsxs17(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx27("span", { style: { color: "var(--photon-builder-text-muted)" }, children: slot.label }),
            /* @__PURE__ */ jsx27("span", { "aria-hidden": "true", children: "\u2192" }),
            /* @__PURE__ */ jsx27("span", { style: { color: "var(--photon-builder-text)" }, children: actionLabel })
          ]
        }
      ),
      policyCount > 0 ? /* @__PURE__ */ jsxs17(
        "span",
        {
      ...
      steps > 1 ? /* @__PURE__ */ jsxs17("span", { className: "opacity-70 normal-case tracking-normal", children: [
        "\xB7 ",
        steps,
        " step",
        steps === 1 ? "" : "s"
      ...
      /* @__PURE__ */ jsx27(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsx27(Settings2, { className: "h-3 w-3" })
        }
      )
    ]
  }
  ...
  return /* @__PURE__ */ jsxs18(Fragment3, { children: [
    /* @__PURE__ */ jsxs18(
      CanvasBlockShell,
      {
        ...
        children: [
          respectsCollapsedState && isCollapsed ? /* @__PURE__ */ jsx28(CollapsedBlockPreview, { block }) : /* @__PURE__ */ jsx28(
            PhotonBlockRenderer,
            {
              block,
              renderArea: (area) => /* @__PURE__ */ jsx28(PhotonRenderDepthProvider, { value: renderDepth + 1, children: /* @__PURE__ */ jsx28(
                CanvasBlockList,
                {
                  blocks: area.blocks,
          ...
          builderEnabled && isSelected ? /* @__PURE__ */ jsxs18(Fragment4, { children: [
            /* @__PURE__ */ jsx28(CanvasBlockStateOverlay, { block }),
            /* @__PURE__ */ jsx28(TriggerOverlay, { block }),
            /* @__PURE__ */ jsx28(CanvasTriggerStage, { block })
          ] }) : null
        ]
      }
    ),
...
var CanvasBlockList = ({
  ...
  dropTarget,
  onActivateInsertTarget
}) => /* @__PURE__ */ jsxs19("div", { className: "space-y-[var(--photon-list-gap,0.75rem)]", children: [
  /* @__PURE__ */ jsx29(
    CanvasInsertZone,
    {
      listId,
  ...
  blocks.map((block, index) => /* @__PURE__ */ jsx29(
    CanvasBlockItem,
    {
      block,
      index,
...
import { memo as memo4, useEffect as useEffect4, useRef, useState as useState10 } from "react";
    ...
    PhotonSurfaceLayoutProvider,
    {
      ...
      children: /* @__PURE__ */ jsxs20(
        "section",
        {
          ...
          children: [
            builderEnabled ? /* @__PURE__ */ jsxs20(
              "div",
              {
                className: clsx7(
                ...
                children: [
                  ...
                  region.lockedOnCanvas ? /* @__PURE__ */ jsx30(
                    "div",
                    {
...
var SiteSurfaceCanvasComponent = ({
  ...
  return /* @__PURE__ */ jsx30("div", { className: "flex min-h-[var(--photon-site-surface-min-height,100dvh)] flex-col gap-[var(--photon-section-gap,2rem)]", children: regions.map((region) => /* @__PURE__ */ jsx30(
...
import { useEffect as useEffect8, useMemo as useMemo7, useRef as useRef2 } from "react";
      ...
      children: [
        /* @__PURE__ */ jsx31(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx31(PanelsTopLeft2, { className: "h-5 w-5" })
          }
        ),
...
var formatCompleteness = (percentage) => `${percentage}%`;
var EditorLocaleSelect = ({
  ...
  const trigger = /* @__PURE__ */ jsxs22(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs22("span", { className: "flex min-w-0 items-center gap-2.5", children: [
          /* @__PURE__ */ jsx32("span", { className: "text-[10px] uppercase tracking-[0.24em] text-[color:var(--photon-builder-text-soft)]", children: label }),
          /* @__PURE__ */ jsx32("span", { className: "truncate uppercase", children: activeOption.label }),
          activeOption.status === "draft" ? /* @__PURE__ */ jsx32(
            "span",
            {
        ...
        /* @__PURE__ */ jsx32(ChevronDown3, { className: "h-4 w-4 shrink-0 text-[color:var(--photon-builder-text-soft)] transition-transform duration-200 ease-out" })
      ]
    }
  );
  if (!hasMounted) {
  ...
  return /* @__PURE__ */ jsxs22(Root2, { modal: false, children: [
    /* @__PURE__ */ jsx32(Trigger, { asChild: true, children: trigger }),
    /* @__PURE__ */ jsx32(DropdownMenuContent, { align: "start", children: /* @__PURE__ */ jsx32(
      RadioGroup,
      {
        value,
        onValueChange: (nextLocale) => onChange(nextLocale),
        children: options.map((option) => /* @__PURE__ */ jsx32(DropdownMenuRadioItem, { value: option.code, children: /* @__PURE__ */ jsxs22("span", { className: "flex w-full items-center gap-2.5", children: [
          /* @__PURE__ */ jsx32("span", { className: "text-[10px] uppercase tracking-[0.24em] text-[color:var(--photon-builder-text-soft)]", children: label }),
          /* @__PURE__ */ jsx32("span", { className: "uppercase", children: option.label }),
          option.status === "draft" ? /* @__PURE__ */ jsx32("span", { className: "rounded-full border border-[color:var(--photon-builder-border)] px-1.5 py-px text-[9px] font-semibold uppercase tracking-[0.2em] text-[color:var(--photon-builder-text-ghost)]", children: "draft" }) : null,
          typeof option.completeness === "number" ? /* @__PURE__ */ jsx32(
            "span",
            {
              ...
              children: formatCompleteness(option.completeness)
            }
          ) : null
        ] }) }, option.code))
      }
...
var EditorModeSelect = ({
  ...
  const trigger = /* @__PURE__ */ jsxs23(
    "button",
    {
      ...
      className: "inline-flex h-11 min-w-[10.25rem] cursor-pointer items-center justify-between gap-3 rounded-full border px-4 text-sm font-semibold shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-[border-color,background-color,box-shadow,color] duration-200 ease-out outline-none border-[color:var(--photon-builder-border)] bg-[color:var(--photon-builder-panel-muted)] text-[color:var(--photon-builder-text)] hover:border-[color:var(--photon-builder-border-strong)] hover:bg-[color:var(--photon-builder-field)] focus-visible:border-[color:var(--photon-builder-border-strong)] focus-visible:bg-[color:var(--photon-builder-accent-strong)]",
      children: [
        /* @__PURE__ */ jsxs23("span", { className: "flex min-w-0 items-center gap-2.5", children: [
          /* @__PURE__ */ jsx33(ActiveIcon, { className: "h-4 w-4 text-[color:var(--photon-builder-accent)]" }),
          /* @__PURE__ */ jsx33("span", { children: activeOption.label })
        ] }),
        /* @__PURE__ */ jsx33(ChevronDown4, { className: "h-4 w-4 text-[color:var(--photon-builder-text-soft)] transition-transform duration-200 ease-out" })
      ]
    }
  );
  if (!hasMounted) {
  ...
  return /* @__PURE__ */ jsxs23(Root2, { modal: false, children: [
    /* @__PURE__ */ jsx33(Trigger, { asChild: true, children: trigger }),
    /* @__PURE__ */ jsx33(DropdownMenuContent, { align: "start", children: /* @__PURE__ */ jsx33(
      RadioGroup,
      {
        ...
        children: MODE_OPTIONS.map((option) => {
          ...
          return /* @__PURE__ */ jsx33(DropdownMenuRadioItem, { value: option.value, children: /* @__PURE__ */ jsxs23("span", { className: "flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsx33(OptionIcon, { className: "h-4 w-4 text-[color:var(--photon-builder-accent)]" }),
...
import { useEffect as useEffect7, useMemo as useMemo6, useState as useState13 } from "react";
...
// src/studio/editor-dock/editor-page-browser.tsx
import { Fragment as Fragment5, jsx as jsx34, jsxs as jsxs24 } from "react/jsx-runtime";
var EditorPageBrowser = ({
  ...
  return /* @__PURE__ */ jsxs24(Fragment5, { children: [
    /* @__PURE__ */ jsxs24(Root2, { open: menuOpen, onOpenChange: setMenuOpen, modal: false, children: [
      /* @__PURE__ */ jsx34(Trigger, { asChild: true, children: /* @__PURE__ */ jsxs24(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxs24("span", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxs24("span", { className: "flex items-center gap-2.5", children: [
                /* @__PURE__ */ jsx34(FolderTree, { className: "h-4 w-4 text-[color:var(--photon-builder-accent)]" }),
                /* @__PURE__ */ jsx34("span", { className: "truncate text-sm font-semibold", children: currentPage?.name ?? translate(
                  "photon.pageBrowser.groups.pages",
                  "Pages"
                ) })
              ] }),
              /* @__PURE__ */ jsx34("span", { className: "mt-0.5 block truncate text-[11px] uppercase tracking-[0.22em] text-[color:var(--photon-builder-text-soft)]", children: currentRouteLabel })
            ] }),
            /* @__PURE__ */ jsx34(ChevronDown5, { className: "h-4 w-4 shrink-0 text-[color:var(--photon-builder-text-soft)]" })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxs24(DropdownMenuContent, { className: "w-[22rem] p-0", children: [
        /* @__PURE__ */ jsxs24(
          "div",
          {
            ...
            children: [
              ...
              onCreatePage ? /* @__PURE__ */ jsxs24(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx34(FilePlus2, { className: "h-4 w-4" }),
                ...
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs24("div", { className: "min-w-0", children: [
                      ...
                      page.description ? /* @__PURE__ */ jsx34(
                        "div",
                        {
    ...
    /* @__PURE__ */ jsx34(
      Root,
      {
        ...
        children: /* @__PURE__ */ jsxs24(DialogContent, { "data-testid": "photon-page-browser-create-dialog", children: [
          /* @__PURE__ */ jsxs24(DialogHeader, { children: [
            /* @__PURE__ */ jsx34(DialogTitle, { children: "Create Page" }),
            /* @__PURE__ */ jsx34(DialogDescription, { children: "Add a new static page to the live website and start editing it in the same builder surface." })
          ] }),
          /* @__PURE__ */ jsxs24("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs24("label", { className: "block", children: [
              /* @__PURE__ */ jsx34(
                "div",
                {
            ...
            canDuplicateCurrent ? /* @__PURE__ */ jsxs24("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx34(
                "div",
                {
              ...
              /* @__PURE__ */ jsxs24("div", { className: "grid gap-2 sm:grid-cols-2", children: [
                /* @__PURE__ */ jsxs24(
                  "button",
                  {
                    type: "button",
                    ...
                    children: [
                      /* @__PURE__ */ jsx34("div", { className: "text-sm font-semibold", children: "Blank page" }),
                      /* @__PURE__ */ jsx34("div", { className: "mt-1 text-xs leading-5", children: "Start from a clean canvas." })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs24(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx34("div", { className: "text-sm font-semibold", children: "Duplicate current" }),
                      /* @__PURE__ */ jsx34("div", { className: "mt-1 text-xs leading-5", children: "Copy the current page layout into the new route." })
                    ]
                  }
                )
              ] })
...
var EditorResetDialog = ({
  ...
  return /* @__PURE__ */ jsx35(Root, { open, onOpenChange, children: /* @__PURE__ */ jsxs25(DialogContent, { children: [
    /* @__PURE__ */ jsxs25(DialogHeader, { children: [
      /* @__PURE__ */ jsx35(DialogTitle, { children: "Discard local draft?" }),
      /* @__PURE__ */ jsx35(DialogDescription, { children: "This will remove every unsaved local change and restore the last version synced with Laravel." })
    ] }),
...
var EditorSaveButton = ({
  ...
  return /* @__PURE__ */ jsxs26(Fragment6, { children: [
    /* @__PURE__ */ jsxs26(Root3, { children: [
      /* @__PURE__ */ jsx36(Trigger2, { asChild: true, children: /* @__PURE__ */ jsxs26(
        "button",
        {
          type: "button",
          onClick: onSave,
          ...
          children: [
            saveState === "saving" ? /* @__PURE__ */ jsx36(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx36(Save, { className: "h-4 w-4" }),
            /* @__PURE__ */ jsx36(
              "span",
              {
            ...
            /* @__PURE__ */ jsx36("span", { children: meta.label })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxs26(ContextMenuContent, { children: [
        /* @__PURE__ */ jsxs26(ContextMenuItem, { onSelect: onSave, children: [
          /* @__PURE__ */ jsx36(Save, { className: "mr-3 h-4 w-4 text-[color:var(--photon-builder-text-soft)]" }),
          "Save now"
        ] }),
        /* @__PURE__ */ jsxs26(
          ContextMenuItem,
          {
            ...
            children: [
              /* @__PURE__ */ jsx36(History, { className: "mr-3 h-4 w-4 text-[color:var(--photon-builder-text-soft)]" }),
              "Revert local draft"
            ]
          }
        ),
        /* @__PURE__ */ jsx36(ContextMenuSeparator, {}),
        activeMode === "preview" && collapsedBlockCount > 0 ? /* @__PURE__ */ jsxs26(ContextMenuItem, { onSelect: onPreviewCollapsedChange, children: [
          /* @__PURE__ */ jsx36(ChevronRight2, { className: "mr-3 h-4 w-4 rotate-90 text-[color:var(--photon-builder-text-soft)]" }),
...
var EditorDock = ({
  ...
  const compact = true;
  const editableLocaleCodes = useMemo7(
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs27(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx37(EditorDockBrand, { title, compact }),
                /* @__PURE__ */ jsx37(
                  "div",
                  {
                    className: clsx10(
                    ...
                    children: canManage ? /* @__PURE__ */ jsxs27(Fragment7, { children: [
                      /* @__PURE__ */ jsx37(
                        EditorPageBrowser,
                        {
                          activeMode,
                      ...
                      showInterfaceLocaleControl ? /* @__PURE__ */ jsx37(
                        EditorLocaleSelect,
                        {
                          label: translate(
                      ...
                      workspaceControl ? /* @__PURE__ */ jsxs27(
                        "button",
                        {
                          type: "button",
                          ...
                          children: [
                            /* @__PURE__ */ jsx37(WorkspaceIcon, { className: "h-4 w-4 text-[color:var(--photon-builder-accent)]" }),
                            /* @__PURE__ */ jsx37("span", { children: "Workspace" })
                          ]
                        }
                      ) : null,
                      /* @__PURE__ */ jsx37(EditorModeSelect, { value: activeMode, onChange: onModeChange }),
                      /* @__PURE__ */ jsx37(
                        EditorSaveButton,
                        {
                          activeMode,
                      ...
                      /* @__PURE__ */ jsxs27(ToolbarButton, { onClick: onLogout, children: [
                        /* @__PURE__ */ jsx37(LogOut, { className: "h-4 w-4" }),
                        translate("photon.auth.logOut", "Log out")
                      ] })
                    ] }) : /* @__PURE__ */ jsxs27(ToolbarButton, { onClick: onAuthOpen, children: [
                      /* @__PURE__ */ jsx37(LogIn, { className: "h-4 w-4" }),
      ...
      children: /* @__PURE__ */ jsxs28("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx38(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx38(Icon, { className: "h-4 w-4" })
          }
        ),
        /* @__PURE__ */ jsxs28("div", { className: "min-w-0 flex-1", children: [
          ...
          /* @__PURE__ */ jsx38("div", { className: "mt-1 truncate text-[1.05rem] font-semibold leading-6", children: definition.label }),
          /* @__PURE__ */ jsx38(
            "div",
            {
...
import { memo as memo5, useEffect as useEffect10, useMemo as useMemo8, useRef as useRef3, useState as useState16 } from "react";
...
var PalettePanelComponent = ({
  ...
  const libraryItemIdsKey = useMemo8(
  ...
  return /* @__PURE__ */ jsxs30(Fragment8, { children: [
    /* @__PURE__ */ jsxs30("div", { className: "flex h-full flex-col", children: [
      /* @__PURE__ */ jsxs30(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs30("div", { className: "relative mt-4", children: [
              /* @__PURE__ */ jsx40(
                Search,
                {
              ...
              /* @__PURE__ */ jsx40("div", { className: "absolute right-2 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsxs30(Root2, { modal: false, children: [
                  ...
                  DropdownMenuContent,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs30("div", { className: "space-y-2", children: [
                        ...
                        /* @__PURE__ */ jsxs30("div", { className: "flex flex-wrap gap-2", children: [
                          /* @__PURE__ */ jsx40(
                            "button",
                            {
                              type: "button",
      ...
      /* @__PURE__ */ jsx40("div", { className: "flex-1 overflow-y-auto px-4 py-4", children: paletteTab === "library" ? /* @__PURE__ */ jsxs30("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs30(
          "section",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs30(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx40(Library, { className: "h-3.5 w-3.5" }),
          ...
          return /* @__PURE__ */ jsxs30(
            "section",
            {
              ...
              children: [
                ...
                selected ? /* @__PURE__ */ jsxs30("div", { className: "mt-4 space-y-3", children: [
                  /* @__PURE__ */ jsxs30("label", { className: "grid gap-2 text-xs font-semibold", children: [
                    "Label",
                    /* @__PURE__ */ jsx40(
                      "input",
                      {
                  ...
                  /* @__PURE__ */ jsxs30("div", { className: "flex flex-wrap gap-2", children: [
                    /* @__PURE__ */ jsxs30(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx40(SlidersHorizontal, { className: "h-3.5 w-3.5" }),
                          "Edit source"
                        ]
                      }
                    ),
                    ...
                    /* @__PURE__ */ jsxs30(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx40(Copy2, { className: "h-3.5 w-3.5" }),
                          "Copy"
                        ]
                      }
                    ),
                    ...
                    /* @__PURE__ */ jsxs30(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx40(Trash24, { className: "h-3.5 w-3.5" }),
                          "Delete source"
                        ]
                      }
                    ),
                    selectedReferenceBlock?.props.itemId === item.id ? /* @__PURE__ */ jsxs30(
                      "button",
                      {
                        type: "button",
        ...
        visibleLibraryItems.length === 0 ? /* @__PURE__ */ jsx40(
          "section",
          {
      ...
      ] }) : /* @__PURE__ */ jsx40("div", { className: "space-y-4", children: paletteGroups.map((familyGroup) => /* @__PURE__ */ jsxs30("section", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxs30(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxs30("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsx40("span", { className: "font-mono text-[11px] uppercase tracking-[0.24em] text-[color:var(--photon-builder-text-ghost)]", children: familyGroup.groups.reduce(
                  (total, group) => total + group.definitions.length,
                  0
                ) })
              ] }),
              /* @__PURE__ */ jsx40("div", { style: { color: "var(--photon-builder-text-ghost)" }, children: collapsedFamilies.includes(familyGroup.family) ? /* @__PURE__ */ jsx40(ChevronRight3, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx40(ChevronDown6, { className: "h-4 w-4" }) })
            ]
          }
        ),
        collapsedFamilies.includes(familyGroup.family) ? null : familyGroup.groups.map(({ group, definitions }) => {
          ...
          return /* @__PURE__ */ jsxs30("section", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxs30(
              "button",
              {
                type: "button",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx40(
                    ...
                    {
                      style: { color: "var(--photon-builder-text-ghost)" },
                      children: collapsed ? /* @__PURE__ */ jsx40(ChevronRight3, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx40(ChevronDown6, { className: "h-4 w-4" })
                    }
                  )
                ]
              }
...
var useStudioDefinitionCatalog = (input) => useMemo9(
...
import { useCallback as useCallback2, useEffect as useEffect12, useMemo as useMemo10, useRef as useRef4, useState as useState19 } from "react";
...
var useStudioPersistence = ({
  ...
  const normalizedWorkspace = useMemo10(
    () => normalizePhotonStudioWorkspace(workspace),
    [workspace]
  );
  const normalizedCapabilities = useMemo10(
    () => normalizePhotonStudioCapabilities(capabilities),
    [capabilities]
  );
  const workspaceKey = useMemo10(
    () => resolvePhotonStudioWorkspaceKey(normalizedWorkspace),
    [normalizedWorkspace]
  );
  const draftStorageScopeKey = useMemo10(
  ...
  const canSaveDocument = useMemo10(
  ...
  const initialStateFingerprint = useMemo10(
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx42(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs31("div", { className: "flex h-10 items-center justify-between gap-3 px-4 sm:px-6 lg:px-8", children: [
            /* @__PURE__ */ jsx42(
                ...
                children: [
                  /* @__PURE__ */ jsx42(
                    CanvasTopToolbarButton,
                    {
                      ...
                      children: /* @__PURE__ */ jsx42(History2, { className: clsx13("h-[13px] w-[13px]") })
                    }
                  ),
                  /* @__PURE__ */ jsx42(
                    CanvasTopToolbarButton,
                    {
                      ...
                      children: /* @__PURE__ */ jsx42(ChevronDown7, { className: "h-[13px] w-[13px]" })
                    }
                  ),
                  /* @__PURE__ */ jsx42(
                    CanvasTopToolbarButton,
                    {
                      ...
                      onClick: onExpandAll,
                      disabled: surfaceMode !== "canvas",
                      children: /* @__PURE__ */ jsx42(ChevronUp2, { className: "h-[13px] w-[13px]" })
                    }
                  )
                ]
              }
...
import { useEffect as useEffect14, useMemo as useMemo14, useRef as useRef6, useState as useState21 } from "react";
...
var ActionStateCards = ({
  ...
  return /* @__PURE__ */ jsxs32(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx43("div", { className: "text-xs uppercase tracking-wide", style: subtleStyle2, children: "States" }),
        /* @__PURE__ */ jsx43("div", { className: "flex flex-wrap gap-2", children: states.map((state) => {
          ...
          return /* @__PURE__ */ jsxs32(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx43("div", { className: "font-semibold", children: state.label }),
                conditionLabel ? /* @__PURE__ */ jsxs32("div", { className: "text-xs", style: subtleStyle2, children: [
                  "when ",
                  conditionLabel
                ] }) : /* @__PURE__ */ jsx43("div", { className: "text-xs italic", style: subtleStyle2, children: "no condition" })
              ]
            },
            state.id
          );
...
var ActionChain = ({
  ...
  return /* @__PURE__ */ jsxs33("div", { className: "flex flex-col gap-2", "data-testid": "photon-action-chain", children: [
    /* @__PURE__ */ jsxs33("div", { className: "rounded-[20px] border p-3 text-sm", style: cardStyle2, children: [
      /* @__PURE__ */ jsx44("div", { className: "text-xs uppercase tracking-wide opacity-70", children: "Trigger" }),
      /* @__PURE__ */ jsx44("div", { className: "font-semibold", children: "Click" })
    ] }),
    steps.map((step) => /* @__PURE__ */ jsxs33("div", { className: "flex flex-col items-center gap-2", children: [
      /* @__PURE__ */ jsx44("div", { className: "text-xl", style: arrowStyle, children: "\u2193" }),
      /* @__PURE__ */ jsxs33(
        "div",
        {
          ...
          style: cardStyle2,
          children: [
            /* @__PURE__ */ jsx44("div", { className: "text-xs uppercase tracking-wide opacity-70", children: "Prerequisite" }),
            /* @__PURE__ */ jsx44("div", { className: "font-semibold", children: labelFor(step.actionInstanceId) }),
            /* @__PURE__ */ jsxs33("div", { className: "mt-1 text-xs opacity-60", children: [
              "via policy: ",
              /* @__PURE__ */ jsx44("code", { children: step.policyId })
            ] })
          ]
        }
      )
    ...
    /* @__PURE__ */ jsxs33("div", { className: "flex flex-col items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxs33(
        "div",
        {
          ...
          style: cardStyle2,
          children: [
            /* @__PURE__ */ jsx44("div", { className: "text-xs uppercase tracking-wide opacity-70", children: "Target" }),
            /* @__PURE__ */ jsx44("div", { className: "font-semibold", children: targetLabel })
          ]
        }
      )
    ] })
...
// src/studio/interaction-surfaces-surface/policies-panel.tsx
import { Fragment as Fragment9, jsx as jsx45, jsxs as jsxs34 } from "react/jsx-runtime";
...
var PoliciesPanel = ({
  ...
  const conditionDefinitionsById = useMemo13(
    () => new Map(conditionDefinitions.map((c) => [c.id, c])),
    [conditionDefinitions]
  );
  const selectedPolicy = useMemo13(
    () => policies.find((p) => p.id === selectedPolicyId) ?? policies[0] ?? null,
    [policies, selectedPolicyId]
  );
  const hasSiteOverride = useMemo13(
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs34("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsx45("div", { className: "text-xs uppercase tracking-wide", style: subtleStyle2, children: "Policies" }),
          policies.map((policy) => {
            ...
            return /* @__PURE__ */ jsxs34(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx45("div", { className: "font-semibold", children: policyTargetLabel }),
                  /* @__PURE__ */ jsxs34("div", { className: "text-xs", style: subtleStyle2, children: [
                    "when ",
                    policyConditionLabel
                  ] }),
                  /* @__PURE__ */ jsxs34("div", { className: "flex gap-2 text-xs", children: [
                    /* @__PURE__ */ jsx45(
                      "span",
                      {
                    ...
                    /* @__PURE__ */ jsx45("code", { className: "opacity-60", children: policy.id })
                  ] })
                ]
              },
              policy.id
        ...
        selectedPolicy ? /* @__PURE__ */ jsxs34("div", { className: "flex flex-col gap-5", children: [
          /* @__PURE__ */ jsxs34(
            "div",
            {
              className: "flex flex-col gap-2 rounded-[20px] border p-4",
              style: cardStyle,
              children: [
                /* @__PURE__ */ jsx45("div", { className: "text-xs uppercase tracking-wide", style: subtleStyle2, children: "Policy" }),
                /* @__PURE__ */ jsxs34("div", { className: "text-sm", children: [
                  "When ",
                  /* @__PURE__ */ jsx45("strong", { children: conditionLabel }),
                  ", run before",
                  " ",
                  /* @__PURE__ */ jsx45("strong", { children: targetLabel }),
                  "."
                ] }),
                /* @__PURE__ */ jsxs34("div", { className: "flex gap-2 text-xs", children: [
                  /* @__PURE__ */ jsxs34(
                  ...
                  selectedPolicy.priority !== void 0 ? /* @__PURE__ */ jsxs34(
                    "span",
                    {
                      className: "rounded-full border px-2 py-0.5",
                      style: badgeStyle,
                  ...
                  selectedPolicy.enforcement ? /* @__PURE__ */ jsx45(
                    "span",
                    {
                      className: "rounded-full border px-2 py-0.5",
                      style: badgeStyle,
                  ...
                  selectedPolicy.securityMode ? /* @__PURE__ */ jsx45(
                    "span",
                    {
                      className: "rounded-full border px-2 py-0.5",
                      style: badgeStyle,
                ...
                /* @__PURE__ */ jsx45("div", { className: "flex flex-wrap items-center gap-2", children: hasSiteOverride ? /* @__PURE__ */ jsxs34(Fragment9, { children: [
                  /* @__PURE__ */ jsx45(
                    "span",
                    {
                ...
                ] }) : selectedPolicy.scope === "package-default" ? /* @__PURE__ */ jsx45(
                  "button",
                  {
                    type: "button",
                    className: "cursor-pointer rounded-full border px-3 py-1 text-xs font-semibold",
          ...
          /* @__PURE__ */ jsxs34(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx45("div", { className: "text-xs uppercase tracking-wide", style: subtleStyle2, children: "Runs" }),
                runInstance ? /* @__PURE__ */ jsxs34(Fragment9, { children: [
                  /* @__PURE__ */ jsxs34("div", { className: "text-sm", children: [
                    "Action instance: ",
                    /* @__PURE__ */ jsx45("code", { children: selectedPolicy.run })
                  ] }),
                  /* @__PURE__ */ jsx45(
                ...
                ] }) : /* @__PURE__ */ jsxs34("div", { className: "text-sm italic", style: subtleStyle2, children: [
                  "Action instance ",
                  /* @__PURE__ */ jsx45("code", { children: selectedPolicy.run }),
          ...
          /* @__PURE__ */ jsxs34(
            "div",
            {
              ...
              style: cardStyle,
              children: [
                /* @__PURE__ */ jsx45("div", { className: "text-xs uppercase tracking-wide", style: subtleStyle2, children: "Chain preview" }),
                /* @__PURE__ */ jsx45(
                  ActionChain,
                  {
...
var InteractionSurfacesSurface = ({
  ...
  return /* @__PURE__ */ jsx46(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsx46("div", { className: "rounded-[34px] border p-5 sm:p-6", style: shellStyle, children: /* @__PURE__ */ jsxs35("div", { className: "flex flex-col gap-6", children: [
        /* @__PURE__ */ jsxs35("div", { className: "flex flex-col gap-3", children: [
          ...
          /* @__PURE__ */ jsx46("div", { className: "text-2xl font-semibold tracking-[-0.04em] sm:text-3xl", children: "Interactions" }),
          /* @__PURE__ */ jsx46(
            "div",
            {
        ...
        /* @__PURE__ */ jsx46("div", { className: "flex flex-wrap gap-2", children: [
          { key: "actions", label: "Actions" },
          { key: "policies", label: "Policies" },
          { key: "surfaces", label: "Surfaces" },
          { key: "toasts", label: "Toasts" }
        ].map((tab) => /* @__PURE__ */ jsx46(
          "button",
          {
            type: "button",
        ...
        activeTab === "actions" ? /* @__PURE__ */ jsxs35("div", { className: "grid gap-5 lg:grid-cols-[minmax(16rem,0.34fr)_minmax(0,0.66fr)]", children: [
          /* @__PURE__ */ jsxs35("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: [
            /* @__PURE__ */ jsx46(
              "div",
              {
            ...
            /* @__PURE__ */ jsx46("div", { className: "space-y-2", children: actionInstances.map((instance) => /* @__PURE__ */ jsxs35(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ jsx46("div", { className: "text-sm font-semibold", children: instance.label }),
                  /* @__PURE__ */ jsx46(
                    "div",
                    {
          ...
          /* @__PURE__ */ jsx46("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: selectedAction ? /* @__PURE__ */ jsxs35("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs35("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
              /* @__PURE__ */ jsxs35("div", { children: [
                ...
                /* @__PURE__ */ jsx46("div", { className: "mt-2 text-xl font-semibold", children: selectedAction.label })
              ] }),
              /* @__PURE__ */ jsx46(
                "button",
                {
            ...
            /* @__PURE__ */ jsxs35("label", { className: "grid gap-2 text-sm font-semibold", children: [
              "Label",
              /* @__PURE__ */ jsx46(
                "input",
                {
            ...
            selectedActionDefinition?.previewScenarios?.length ? /* @__PURE__ */ jsx46("div", { className: "flex flex-wrap gap-2", children: selectedActionDefinition.previewScenarios.map(
              (scenario) => /* @__PURE__ */ jsx46(
                "button",
                {
                  type: "button",
            ...
            selectedActionDefinition?.states?.length ? /* @__PURE__ */ jsx46(
              ActionStateCards,
              {
            ...
            selectedActionSurfaceRequest && selectedActionFields.length ? /* @__PURE__ */ jsx46(
              PhotonFieldEditorList,
              {
        ...
        activeTab === "policies" ? /* @__PURE__ */ jsx46(
          PoliciesPanel,
          {
        ...
        activeTab === "guards" ? /* @__PURE__ */ jsxs35("div", { className: "grid gap-5 lg:grid-cols-[minmax(16rem,0.34fr)_minmax(0,0.66fr)]", children: [
          /* @__PURE__ */ jsxs35("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: [
            /* @__PURE__ */ jsx46(
              "div",
              {
            ...
            /* @__PURE__ */ jsx46("div", { className: "space-y-2", children: guardInstances.map((instance) => /* @__PURE__ */ jsxs35(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsx46("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: selectedGuard ? /* @__PURE__ */ jsxs35("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs35("div", { children: [
              /* @__PURE__ */ jsx46(
                "div",
                {
              ...
              /* @__PURE__ */ jsx46("div", { className: "mt-2 text-xl font-semibold", children: selectedGuard.label })
            ] }),
            /* @__PURE__ */ jsxs35("label", { className: "grid gap-2 text-sm font-semibold", children: [
              "Label",
              /* @__PURE__ */ jsx46(
        ...
        activeTab === "surfaces" ? /* @__PURE__ */ jsxs35(Fragment10, { children: [
          /* @__PURE__ */ jsxs35("div", { className: "grid gap-5 lg:grid-cols-[minmax(16rem,0.34fr)_minmax(0,0.66fr)]", children: [
            /* @__PURE__ */ jsxs35("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: [
              /* @__PURE__ */ jsx46(
                "div",
                {
              ...
              /* @__PURE__ */ jsx46("div", { className: "mb-4 grid gap-2", children: surfaceDefinitions.map((definition) => /* @__PURE__ */ jsxs35(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsx46("div", { className: "space-y-2", ref: instanceListRef, children: instances.map((instance) => {
              ...
              disabledInstances.length > 0 ? /* @__PURE__ */ jsxs35("div", { className: "mt-5 space-y-2", children: [
                /* @__PURE__ */ jsx46(
                  "div",
                  {
                    className: "text-[10px] uppercase tracking-[0.26em]",
                ...
                disabledInstances.map((instance) => /* @__PURE__ */ jsxs35(
                  "div",
                  {
                    className: "rounded-[18px] border px-3 py-3 text-sm",
                    style: fieldStyle2,
                    children: [
                      /* @__PURE__ */ jsx46("div", { className: "font-semibold", children: instance.label }),
                      /* @__PURE__ */ jsx46(
                        "button",
                        {
                          type: "button",
            ...
            /* @__PURE__ */ jsx46("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: selectedInstance && selectedDefinition ? /* @__PURE__ */ jsxs35("div", { className: "space-y-5", children: [
              /* @__PURE__ */ jsxs35("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between", children: [
                /* @__PURE__ */ jsxs35("div", { children: [
                  /* @__PURE__ */ jsx46(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsx46("div", { className: "mt-2 text-xl font-semibold", children: selectedInstance.label })
                ] }),
                /* @__PURE__ */ jsxs35("div", { className: "flex flex-wrap gap-2", children: [
                  ...
                  defaultInstanceIds.has(selectedInstance.id) ? null : /* @__PURE__ */ jsx46(
                    "button",
                    {
                      type: "button",
              ...
              selectedInstanceDeleteBlocked ? /* @__PURE__ */ jsxs35(
                "div",
                {
                  className: "rounded-[18px] border px-3 py-2 text-xs leading-6",
                  style: fieldStyle2,
              ...
              /* @__PURE__ */ jsxs35("div", { className: "grid gap-4 md:grid-cols-2", children: [
                /* @__PURE__ */ jsxs35("label", { className: "grid gap-2 text-sm font-semibold", children: [
                  "Label",
                  /* @__PURE__ */ jsx46(
                    "input",
                ...
                /* @__PURE__ */ jsxs35("label", { className: "grid gap-2 text-sm font-semibold", children: [
                  ...
                  /* @__PURE__ */ jsxs35(
                    "select",
                    {
                      ...
                      style: fieldStyle2,
                      children: [
                        /* @__PURE__ */ jsx46("option", { value: "", children: "Default" }),
                        (selectedDefinition.variants ?? []).map((variant) => /* @__PURE__ */ jsx46("option", { value: variant.id, children: variant.label }, variant.id))
                      ]
                    }
                  )
                ] })
          ...
          /* @__PURE__ */ jsxs35("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: [
            ...
            /* @__PURE__ */ jsx46("div", { className: "grid gap-3 md:grid-cols-2", children: Object.values(catalog.intents).map((binding) => /* @__PURE__ */ jsxs35(
              "label",
              {
                className: "grid gap-2 rounded-[18px] border p-3 text-sm font-semibold",
                style: fieldStyle2,
                children: [
                  /* @__PURE__ */ jsx46("span", { children: binding.intent }),
                  /* @__PURE__ */ jsx46(
                    "select",
                    {
                      ...
                      className: "h-10 rounded-[14px] border px-3 text-sm outline-none",
                      style: fieldStyle2,
                      children: instances.map((instance) => /* @__PURE__ */ jsx46("option", { value: instance.id, children: instance.label }, instance.id))
                    }
                  )
                ]
              },
        ...
        activeTab === "toasts" ? /* @__PURE__ */ jsx46("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: /* @__PURE__ */ jsxs35("div", { className: "grid gap-5 lg:grid-cols-[minmax(16rem,0.34fr)_minmax(0,0.66fr)]", children: [
          /* @__PURE__ */ jsxs35("div", { children: [
            /* @__PURE__ */ jsx46(
              "div",
              {
            ...
            /* @__PURE__ */ jsx46("div", { className: "space-y-2", children: toastTemplates.map((template) => /* @__PURE__ */ jsxs35(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ jsx46("div", { className: "text-sm font-semibold", children: template.label }),
                  /* @__PURE__ */ jsx46(
                    "div",
                    {
                      className: "mt-1 text-xs",
          ...
          selectedTemplate ? /* @__PURE__ */ jsxs35("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsx46("div", { className: "flex flex-wrap justify-end gap-2", children: /* @__PURE__ */ jsx46(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsxs35("section", { className: "rounded-[28px] border p-4", style: cardStyle3, children: [
          ...
          /* @__PURE__ */ jsx46("div", { className: "flex flex-wrap gap-2", children: catalog.definitions.map((definition) => /* @__PURE__ */ jsx46(
            "span",
            {
              className: clsx14(
...
import { useEffect as useEffect15, useMemo as useMemo15, useState as useState22 } from "react";
...
var SettingsCard = ({
  ...
  description,
  children
}) => /* @__PURE__ */ jsxs36("section", { className: "rounded-[28px] border px-5 py-5", style: surfaceCardStyle, children: [
  /* @__PURE__ */ jsx47(
    "div",
    {
      className: "text-[11px] uppercase tracking-[0.28em]",
...
var PageSettingsSurface = ({
  ...
  const availableScopes = useMemo15(
      ...
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs36("div", { className: "mb-4", children: [
            ...
            panel.description ? /* @__PURE__ */ jsx47(
              "div",
              {
                className: "mt-2 text-sm leading-6",
                style: { color: "var(--photon-builder-text-muted)" },
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsx47(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs36("div", { className: "flex flex-col gap-6", children: [
            /* @__PURE__ */ jsxs36("div", { className: "flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between", children: [
            ...
            activeTab === "page" && availableScopes.length > 0 ? /* @__PURE__ */ jsxs36(Fragment11, { children: [
              /* @__PURE__ */ jsx47(
                "div",
                {
                  className: "inline-flex w-full max-w-full flex-wrap rounded-full border p-1 sm:w-auto",
                  ...
                  children: availableScopes.map((scope) => /* @__PURE__ */ jsx47(
                    "button",
                    {
                      type: "button",
              ...
              /* @__PURE__ */ jsx47(
                SettingsCard,
                {
                  ...
                  children: /* @__PURE__ */ jsxs36("div", { className: "flex flex-wrap items-center gap-2", children: [
                    /* @__PURE__ */ jsx47(
                      "div",
                      {
                        className: "rounded-full border px-3 py-1 text-[10px] uppercase tracking-[0.24em]",
                    ...
                    activeScope === "template" && currentPage?.isDynamic ? /* @__PURE__ */ jsx47(
                      "div",
                      {
                        className: "rounded-full border px-3 py-1 text-[10px] uppercase tracking-[0.24em]",
              ...
              /* @__PURE__ */ jsxs36(
                "section",
                {
                  ...
                  children: [
                    ...
                    activeScope === "page" ? /* @__PURE__ */ jsx47(
                      PhotonFieldEditorList,
                      {
                    ...
                    activeScope === "template" ? /* @__PURE__ */ jsxs36("div", { className: "space-y-4", children: [
                      /* @__PURE__ */ jsx47(
                        "div",
                        {
                    ...
                    activeScope === "record" ? /* @__PURE__ */ jsxs36("div", { className: "space-y-4", children: [
                      /* @__PURE__ */ jsx47(
                        "div",
                        {
                          className: "rounded-2xl border px-4 py-3 text-sm leading-6",
            ...
            activeTab === "site" ? /* @__PURE__ */ jsxs36(Fragment11, { children: [
              /* @__PURE__ */ jsx47(
                SettingsCard,
                {
                  ...
                  children: /* @__PURE__ */ jsxs36("div", { className: "flex flex-wrap items-center gap-2", children: [
                    ...
                    Object.values(site.regions).map((region) => /* @__PURE__ */ jsx47(
                      "div",
                      {
                        className: "rounded-full border px-3 py-1 text-[10px] uppercase tracking-[0.24em]",
                        style: subtleChipStyle,
              ...
              /* @__PURE__ */ jsx47(
                "div",
                {
                  ...
                  children: siteSubtabs.map((tab) => /* @__PURE__ */ jsx47(
                    "button",
                    {
                      type: "button",
              ...
              activeSiteTab === "locales" ? siteLocalesPanel ? renderSitePanel(siteLocalesPanel) : remainingSitePanels.length > 0 ? remainingSitePanels.map((panel) => renderSitePanel(panel)) : /* @__PURE__ */ jsxs36(
                "section",
                {
                  className: "rounded-[28px] border px-5 py-5",
                  style: surfaceCardStyle,
              ...
              siteWorkspaceSubtab ? /* @__PURE__ */ jsxs36(
                "section",
                {
                  className: "rounded-[28px] border px-5 py-5",
                  style: surfaceCardStyle,
                  ...
                  children: [
                    /* @__PURE__ */ jsxs36("div", { className: "mb-4", children: [
                      ...
                      siteWorkspaceSubtab.description ? /* @__PURE__ */ jsx47(
                        "div",
                        {
                          className: "mt-2 text-sm leading-6",
                          style: { color: "var(--photon-builder-text-muted)" },
                    ...
                    /* @__PURE__ */ jsx47(siteWorkspaceSubtab.component, {})
                  ]
                }
              ) : null
            ] }) : null
...
var SiteDataSurface = ({
  ...
  return /* @__PURE__ */ jsxs37(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx48("div", { className: "flex flex-col gap-4", children: siteDataSchemas.map((schema) => /* @__PURE__ */ jsxs37("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxs37("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsx48("div", { className: "text-sm font-semibold", children: schema.label }),
            schema.description ? /* @__PURE__ */ jsx48("div", { className: "text-xs", style: subtleStyle2, children: schema.description }) : null
          ] }),
          /* @__PURE__ */ jsx48("div", { className: "flex flex-col gap-1", children: schema.fields.map((field) => {
            ...
            return /* @__PURE__ */ jsxs37(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx48("div", { className: "font-medium", children: field.label }),
                  /* @__PURE__ */ jsx48("div", { className: "text-xs", style: subtleStyle2, children: /* @__PURE__ */ jsx48("code", { children: `${schema.id}.${field.path}` }) })
                ]
              },
              id
            );
        ...
        selected ? /* @__PURE__ */ jsx48("div", { className: "flex flex-col gap-4", children: /* @__PURE__ */ jsxs37(
          "div",
          {
            className: "flex flex-col gap-3 rounded-[20px] border p-4",
            style: cardStyle,
            children: [
              /* @__PURE__ */ jsxs37("div", { className: "flex items-baseline justify-between gap-2", children: [
                /* @__PURE__ */ jsxs37("div", { children: [
                  ...
                  /* @__PURE__ */ jsx48("div", { className: "text-lg font-semibold", children: selected.field.label })
                ] }),
                isOverridden ? /* @__PURE__ */ jsx48(
                  "span",
                  {
                    className: "rounded-full border px-2 py-0.5 text-xs",
                    style: badgeStyle,
              ...
              selected.field.description ? /* @__PURE__ */ jsx48("div", { className: "text-sm", style: subtleStyle2, children: selected.field.description }) : null,
              /* @__PURE__ */ jsxs37("label", { className: "flex flex-col gap-2 text-xs font-semibold", children: [
                "Value",
                renderEditor(
                  selected.field,
                  value,
              ...
              /* @__PURE__ */ jsxs37("div", { className: "text-xs", style: subtleStyle2, children: [
                "Path: ",
                /* @__PURE__ */ jsx48("code", { children: sitePath(selected.schema.id, selected.field.path) })
              ] })
            ]
          }
        ) }) : null
...
import { memo as memo6, useEffect as useEffect16, useMemo as useMemo19, useState as useState27 } from "react";
...
var PhotonInspectorSection = ({
  ...
  const { tokens } = usePhotonInspectorDensity();
  const [collapsed, setCollapsed] = useState23(defaultCollapsed);
  const toggle = useCallback4(() => setCollapsed((current) => !current), []);
      ...
      children: [
        /* @__PURE__ */ jsxs38(
          "button",
          {
            ...
            children: [
              nonCollapsible ? null : isExpanded ? /* @__PURE__ */ jsx49(
                ChevronDown8,
                {
                  className: "h-3 w-3 shrink-0",
                  style: { color: "var(--photon-builder-text-soft)" }
              ...
              /* @__PURE__ */ jsx49(
                "div",
                {
                  ...
                  style: {
                    color: isGroup ? "var(--photon-builder-text)" : "var(--photon-builder-text-soft)"
                  },
                  children: title
                }
              ),
              trailing ? /* @__PURE__ */ jsx49("div", { className: "shrink-0", children: trailing }) : null
            ]
          }
        ),
        subtitle && isExpanded ? /* @__PURE__ */ jsx49(
          "div",
          {
        ...
        isExpanded ? /* @__PURE__ */ jsx49("div", { className: clsx16(tokens.sectionPadding, "pt-1"), children }) : null
      ]
    }
  );
};
            ...
            items.map((item) => {
              ...
              return /* @__PURE__ */ jsxs39(
                "button",
                {
                  ...
                  children: [
                    item.label,
                    item.group === "state" ? /* @__PURE__ */ jsxs39(
                      "span",
                      {
...
var RouteFamilyEditor = () => {
  ...
  const [draftPattern, setDraftPattern] = useState24("");
  ...
  return /* @__PURE__ */ jsx51(
    PhotonInspectorSection,
    {
      ...
      trailing: patterns.length > 0 ? /* @__PURE__ */ jsx51(
        "span",
        {
          className: "rounded-sm px-1 font-mono text-[9px] tabular-nums",
          style: {
      ...
      children: /* @__PURE__ */ jsxs40(
        "div",
        {
          ...
          children: [
            patterns.length === 0 ? /* @__PURE__ */ jsx51(
              "div",
              {
            ...
            ) : patterns.map((pattern) => /* @__PURE__ */ jsxs40(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx51("span", { className: "flex-1 truncate", children: pattern }),
                  /* @__PURE__ */ jsx51(
                    "button",
                    {
                      type: "button",
                      ...
                      children: /* @__PURE__ */ jsx51(Trash25, { size: 10 })
                    }
                  )
                ]
              },
...
import { useMemo as useMemo18, useState as useState26 } from "react";
...
import { useMemo as useMemo17, useState as useState25 } from "react";
import { Fragment as Fragment12, jsx as jsx52, jsxs as jsxs41 } from "react/jsx-runtime";
var cardStyle4 = {
  borderColor: "var(--photon-builder-border)",
  background: "var(--photon-builder-panel-solid)"
};
      ...
      children: [
        /* @__PURE__ */ jsxs41(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs41("div", { className: "flex flex-1 flex-col gap-0.5", children: [
                /* @__PURE__ */ jsxs41("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx52("span", { className: "font-semibold", children: label }),
                  conditionLabel ? /* @__PURE__ */ jsxs41("span", { style: subtleStyle3, children: [
                    "when ",
                    conditionLabel
                  ] }) : null
                ] }),
                propPreview ? /* @__PURE__ */ jsxs41("div", { className: "truncate", style: mutedStyle, title: propPreview, children: [
                  '"',
                  propPreview,
                  '"'
                ] }) : null
              ] }),
              isBridge ? /* @__PURE__ */ jsx52(
                "span",
                {
        ...
        open ? /* @__PURE__ */ jsxs41(
          "div",
          {
            ...
            children: [
              instance ? /* @__PURE__ */ jsxs41("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx52(
                  "div",
                  {
                ...
                editableInstanceProps(instance).length === 0 ? /* @__PURE__ */ jsx52("div", { className: "text-xs italic", style: mutedStyle, children: "No editable props on this instance." }) : editableInstanceProps(instance).map((entry) => /* @__PURE__ */ jsxs41(
                  "label",
                  {
                    className: "flex flex-col gap-1 text-xs",
                    children: [
                      /* @__PURE__ */ jsx52("span", { style: subtleStyle3, children: entry.key }),
                      entry.kind === "boolean" ? /* @__PURE__ */ jsx52(
                        "input",
                        {
                          type: "checkbox",
                          checked: entry.value,
                      ...
                      ) : entry.kind === "number" ? /* @__PURE__ */ jsx52(
                        "input",
                        {
                          type: "number",
              ...
              /* @__PURE__ */ jsxs41(
                "div",
                {
                  ...
                  children: [
                    ...
                    policy ? /* @__PURE__ */ jsxs41(Fragment12, { children: [
                      /* @__PURE__ */ jsxs41("div", { children: [
                        "policy: ",
                        policy.id
                      ] }),
                      ...
                      policy.priority !== void 0 ? /* @__PURE__ */ jsxs41("div", { children: [
                        "priority: ",
                        policy.priority
                      ] }) : null,
                      /* @__PURE__ */ jsxs41("div", { children: [
              ...
              instance ? /* @__PURE__ */ jsxs41(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx52(Pencil2, { size: 10 }),
                    " Open instance"
                  ]
                }
              ) : null
      ...
      children: [
        /* @__PURE__ */ jsxs42(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs42("span", { style: { color: "var(--photon-builder-text)" }, children: [
                "Run ",
                /* @__PURE__ */ jsx53("strong", { children: policy.run || "(default)" }),
                " when ",
                conditionId
              ] }),
              /* @__PURE__ */ jsxs42(
...
var InspectorTriggerTab = ({
  ...
  const policiesForAction = useMemo18(() => {
  ...
  return /* @__PURE__ */ jsxs42(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs42(
          "header",
          {
            ...
            children: [
              ...
              slot.description ? /* @__PURE__ */ jsx53(
                "p",
                {
        ...
        actionInstanceOptions.length ? /* @__PURE__ */ jsxs42("div", { className: "flex min-h-[24px] items-center gap-2 px-1", children: [
          /* @__PURE__ */ jsx53(
            "div",
            {
          ...
          /* @__PURE__ */ jsxs42(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsx53("option", { value: "", children: "Default action" }),
                actionInstanceOptions.map((instance) => /* @__PURE__ */ jsx53("option", { value: instance.id, children: instance.label }, instance.id))
              ]
            }
          )
        ] }) : null,
        /* @__PURE__ */ jsx53(TriggerActionFlow, { slot }),
        policiesForAction.length ? /* @__PURE__ */ jsxs42(
          "details",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx53("div", { className: "mt-1 space-y-1", children: policiesForAction.map((policy) => /* @__PURE__ */ jsx53(PolicyRow, { policy }, policy.id)) })
            ]
          }
        ) : null,
        hasOverrides ? /* @__PURE__ */ jsx53(
          "button",
          {
            type: "button",
            onClick: () => {
...
// src/studio/inspector-panel/inspector-panel.tsx
import { Fragment as Fragment13, jsx as jsx54, jsxs as jsxs43 } from "react/jsx-runtime";
...
var InspectorPanelComponent = ({
  ...
  const [activeTab, setActiveTab] = useState27("block");
  useEffect16(() => {
  ...
  const blockGroupKeys = useMemo19(
  ...
  const selectedBlockJson = useMemo19(
    () => selectedBlock ? JSON.stringify(selectedBlock, null, 2) : "",
    [selectedBlock]
  );
  const documentJson = useMemo19(
    () => JSON.stringify(
      {
        id: document2.id,
      ...
      children: [
        /* @__PURE__ */ jsxs43(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx54("div", { className: "flex min-w-0 items-center gap-1", children: [
                {
                  key: "block",
                  label: translate(
              ...
              onCollapse ? /* @__PURE__ */ jsx54(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsx54(ChevronRight6, { className: "h-3.5 w-3.5" })
                }
              ) : null
            ]
          }
        ...
        /* @__PURE__ */ jsxs43(
          "div",
          {
            ...
            children: [
              activeTab === "block" && !selectedBlock && inspectorDefinition ? /* @__PURE__ */ jsxs43(Fragment13, { children: [
                /* @__PURE__ */ jsxs43(
                  PhotonInspectorSection,
                  {
                ...
                Object.entries(inspectorGroups).map(([groupKey, fields]) => /* @__PURE__ */ jsx54(
                  PhotonInspectorSection,
                  {
                    ...
                    children: /* @__PURE__ */ jsx54("div", { className: "space-y-1", children: fields.map((field) => /* @__PURE__ */ jsxs43(
                      "div",
                      {
                        className: "rounded-sm px-2 py-1.5",
                        style: {
                        ...
                        children: [
                          ...
                          field.description ? /* @__PURE__ */ jsx54(
                            "div",
                            {
              ...
              activeTab === "surfaces" && selectedBlock && hasSurfaces ? /* @__PURE__ */ jsxs43(Fragment13, { children: [
                /* @__PURE__ */ jsx54(
                  "div",
                  {
                    className: "flex flex-wrap gap-1",
                ...
                activeTriggerSlot ? /* @__PURE__ */ jsx54(
                  InspectorTriggerTab,
                  {
                    block: selectedBlock,
              ...
              activeTab === "layout" && selectedBlock && hasLayoutFields ? /* @__PURE__ */ jsx54(
                "div",
                {
                  ...
                  children: chunkInspectorGroupFields(
                    ...
                    (chunk) => chunk.kind === "block" ? /* @__PURE__ */ jsx54(
                      FieldEditor,
                      {
                        field: chunk.field,
                      ...
                      PhotonInspectorSection,
                      {
                        id: `layout-${chunk.id}`,
                        title: chunk.title,
                        children: /* @__PURE__ */ jsx54("div", { className: "flex flex-col gap-0.5", children: chunk.fields.map((field) => /* @__PURE__ */ jsx54(
                          FieldEditor,
                          {
                            field,
                            blockId: selectedBlock.id,
              ...
              activeTab === "block" && selectedBlock ? /* @__PURE__ */ jsxs43(Fragment13, { children: [
                /* @__PURE__ */ jsxs43(
                  PhotonInspectorSection,
                  {
                    id: "selected-block",
                    ...
                    trailing: inspectorDefinition ? /* @__PURE__ */ jsx54(
                      "span",
                      {
                        className: "rounded-sm px-1.5 py-0 text-[10px] uppercase tracking-[0.14em]",
                        style: {
                    ...
                    children: [
                      /* @__PURE__ */ jsx54("div", { className: "flex flex-wrap items-center gap-1", children: /* @__PURE__ */ jsx54(
                        "span",
                        {
                      ...
                      inspectorDefinition?.description ? /* @__PURE__ */ jsx54(
                        "div",
                        {
                          className: "mt-1 text-[11px] leading-snug",
                          style: { color: "var(--photon-builder-text-muted)" },
                      ...
                      selectedFieldPath ? /* @__PURE__ */ jsxs43(
                        "div",
                        {
                          ...
                          children: [
                            "Active field:",
                            " ",
                            /* @__PURE__ */ jsx54("span", { className: "font-mono", children: selectedFieldPath })
                          ]
                        }
                      ) : null
                    ]
                ...
                /* @__PURE__ */ jsx54(BlockPreviewScenariosPicker, { block: selectedBlock }),
              ...
              activeTab === "block" ? /* @__PURE__ */ jsxs43(Fragment13, { children: [
                /* @__PURE__ */ jsx54(
                  PhotonInspectorSection,
                  {
                    id: "block-advanced",
                    ...
                    children: /* @__PURE__ */ jsxs43("div", { className: "flex flex-col gap-1", children: [
                      selectedBlock ? /* @__PURE__ */ jsx54(
                        PhotonInspectorSection,
                        {
                ...
                !definitionFields.length && !hasBlockContext ? /* @__PURE__ */ jsx54(
                  "section",
                  {
              ...
              activeTab === "page" ? /* @__PURE__ */ jsxs43(Fragment13, { children: [
                /* @__PURE__ */ jsxs43(
                  PhotonInspectorSection,
                  {
                    id: "page-summary",
                    ...
                    children: [
                      /* @__PURE__ */ jsxs43("div", { className: "flex flex-wrap items-center gap-1", children: [
                        ...
                        currentPage?.isDynamic ? /* @__PURE__ */ jsx54("span", { className: "rounded-sm bg-amber-300/10 px-1.5 py-0 text-[10px] uppercase tracking-[0.14em] text-amber-100/80", children: "Dynamic template" }) : null
                      ] }),
                      /* @__PURE__ */ jsx54(
                        "div",
                        {
                ...
                /* @__PURE__ */ jsx54(
                  PhotonInspectorSection,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs43("div", { className: "space-y-1", children: [
                      /* @__PURE__ */ jsxs43(
                        "div",
                        {
                          className: "rounded-sm px-2 py-1.5",
                      ...
                      currentPage?.isDynamic ? /* @__PURE__ */ jsxs43(
                        "div",
                        {
                          className: "rounded-sm px-2 py-1.5",
                          style: { background: "var(--photon-builder-field)" },
                ...
                /* @__PURE__ */ jsx54(RouteFamilyEditor, {})
              ] }) : null
            ]
          }
        )
...
var InspectorPanelWithDensity = (props) => /* @__PURE__ */ jsx54(PhotonInspectorDensityProvider, { children: /* @__PURE__ */ jsx54(InspectorPanelComponent, { ...props }) });
...
var BuilderMobilePanels = ({
  ...
  return /* @__PURE__ */ jsxs44("div", { className: "mt-6 grid gap-4 lg:hidden", children: [
    /* @__PURE__ */ jsx55(
      PalettePanel,
      {
        paletteTab,
...
var BuilderSidebarEdgeToggle = ({
  ...
  return /* @__PURE__ */ jsx56(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx56("div", { className: "group relative h-full w-full", children: /* @__PURE__ */ jsx56(
        "button",
        {
          type: "button",
          ...
          children: side === "left" ? /* @__PURE__ */ jsx56(ChevronRight7, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx56(ChevronLeft2, { className: "h-4 w-4" })
        }
      ) })
    }
  );
...
// src/studio/photon-studio/builder-sidebars.tsx
import { Fragment as Fragment14, jsx as jsx58, jsxs as jsxs46 } from "react/jsx-runtime";
var BuilderSidebars = ({
  sidebarsVisible,
  dockHeight,
  isResizing,
  ...
  const [transitionsEnabled, setTransitionsEnabled] = useState28(false);
  ...
  return /* @__PURE__ */ jsxs46(Fragment14, { children: [
    transitionsEnabled && sidebarsVisible && leftCollapsed ? /* @__PURE__ */ jsx58(
    ...
    transitionsEnabled && sidebarsVisible && rightCollapsed ? /* @__PURE__ */ jsx58(
      BuilderSidebarEdgeToggle,
      {
        side: "right",
        dockHeight,
    ...
    /* @__PURE__ */ jsxs46(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx58("div", { className: "min-w-0", children }),
          /* @__PURE__ */ jsx58(
            "aside",
            {
              className: clsx20(
                  ...
                  children: [
                    /* @__PURE__ */ jsx59(
                      "div",
                      {
                        ...
                        children: builderEnabled && builderSurfaceMode === "settings" ? /* @__PURE__ */ jsx59(
                          PageSettingsSurface,
                          {
                            currentPage,
                            pageSettings,
                        ...
                        ) : builderEnabled && builderSurfaceMode === "interactions" ? /* @__PURE__ */ jsx59(
                        ...
                        ) : builderEnabled && builderSurfaceMode === "data" ? /* @__PURE__ */ jsx59(
                          SiteDataSurface,
                          {
                            siteDataSchemas,
                            selectedDataFieldId,
                    ...
                    contentEnabled && contentNotice ? /* @__PURE__ */ jsx59("div", { className: "mx-auto mt-4 max-w-[1480px]", children: contentNotice }) : null,
                    builderEnabled && builderSurfaceMode === "canvas" ? /* @__PURE__ */ jsx59(
                      BuilderMobilePanels,
                      {
                        paletteTab,
                        onPaletteTabChange,
...
var PhotonStudioInner = ({
  ...
  const [paletteFamily, setPaletteFamily] = useState29("all");
  const [palettePackage, setPalettePackage] = useState29("all");
  const [selectedPaletteKey, setSelectedPaletteKey] = useState29(
    null
  );
  const [manualInsertTarget, setManualInsertTarget] = useState29(null);
  const [paletteCollapsedGroups, setPaletteCollapsedGroups] = useState29([]);
  const [paletteCollapsedFamilies, setPaletteCollapsedFamilies] = useState29([]);
  const [dockHeight, setDockHeight] = useState29(
    PHOTON_EDITOR_DOCK_FALLBACK_HEIGHT
  );
  const [showCollapsedInPreview, setShowCollapsedInPreview] = useState29(false);
  const [hasMounted, setHasMounted] = useState29(false);
  ...
  const flushActiveInlineField = useCallback5(async () => {
    if (typeof window !== "undefined") {
  ...
  const saveDocumentManually = useCallback5(async () => {
  ...
  const [paletteTab, setPaletteTab] = useState29(
    initialStudioUrlState.paletteTab ?? "blocks"
  );
  const [selectedLibraryItemId, setSelectedLibraryItemId] = useState29(initialStudioUrlState.library ?? null);
  const [interactionTab, setInteractionTab] = useState29(
    initialStudioUrlState.interactionTab ?? "actions"
  );
  const [selectedInteractionActionId, setSelectedInteractionActionId] = useState29(initialStudioUrlState.action ?? null);
  const [selectedInteractionGuardId, setSelectedInteractionGuardId] = useState29(initialStudioUrlState.guard ?? null);
  const [selectedInteractionPolicyId, setSelectedInteractionPolicyId] = useState29(initialStudioUrlState.policy ?? null);
  const [selectedDataFieldId, setSelectedDataFieldId] = useState29(initialStudioUrlState.dataField ?? null);
  const [selectedInteractionScenarioId, setSelectedInteractionScenarioId] = useState29(initialStudioUrlState.scenario ?? null);
  const [selectedInteractionSurfaceId, setSelectedInteractionSurfaceId] = useState29(initialStudioUrlState.surface ?? null);
  const [selectedInteractionToastId, setSelectedInteractionToastId] = useState29(initialStudioUrlState.toast ?? null);
  useEffect19(() => {
  ...
  return /* @__PURE__ */ jsxs48("div", { className: "relative min-h-screen", children: [
    /* @__PURE__ */ jsx60(
      PhotonSearchHighlightEffect,
      {
          ...
          hasMounted ? createPortal(
            /* @__PURE__ */ jsx60(
              DragOverlay,
              {
                ...
                children: activeDragKind === "palette" && activePaletteDefinition ? /* @__PURE__ */ jsx60(PaletteOverlayCard, { definition: activePaletteDefinition }) : activeBlock ? /* @__PURE__ */ jsx60(BlockOverlayCard, { block: activeBlock }) : null
              }
            ),
