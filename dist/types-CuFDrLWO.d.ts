...
type WebsiteBuilderAccountTabMatch = {
    type: "exact";
    href: string;
} | {
    type: "prefix";
...
export type { WebsiteBuilderLinkComponentProps as $, WebsiteBuilderRegistry as A, WebsiteBuilderRevisionDescriptor as B, WebsiteBuilderBranchPolicyState as C, WebsiteBuilderMergePreview as D, WebsiteBuilderMode as E, WebsiteBuilderMediaUploadHandler as F, WebsiteBuilderSearchHandler as G, WebsiteBuilderLinkComponent as H, WebsiteBuilderI18nValue as I, WebsiteBuilderField as J, WebsiteBuilderPageSettingsPanelDefinition as K, WebsiteBuilderSiteSettingsPanelDefinition as L, WebsiteBuilderBlockDefinition as M, WebsiteBuilderNestedField as N, WebsiteBuilderBlockLocalizationSchema as O, WebsiteBuilderModule as P, WebsiteBuilderLocalizedDefaultValue as Q, WebsiteBuilderRegistryEntry as R, WebsiteBuilderBlockProps as S, WebsiteBuilderInstallableKit as T, WebsiteBuilderRuntime as U, WebsiteBuilderSiteDesignSettings as V, WebsiteBuilderArea as W, WebsiteBuilderResolvedSiteDesignSettings as X, WebsiteBuilderSiteComponentVariants as Y, WebsiteBuilderWorkspaceRef as Z, WebsiteBuilderSelectedField as _, WebsiteBuilderBlock as a, WebsiteBuilderBindingAdapter as a0, WebsiteBuilderBlockComponentProps as a1, WebsiteBuilderFieldOption as a2, WebsiteBuilderPageSettingsScope as a3, WebsiteBuilderAccountTabMatch as a4, WebsiteBuilderActorSummary as a5, WebsiteBuilderAnyBlockDefinition as a6, WebsiteBuilderBindingMode as a7, WebsiteBuilderBlockComponent as a8, WebsiteBuilderBlockDefaults as a9, WebsiteBuilderDefaultable as aa, WebsiteBuilderFieldKind as ab, WebsiteBuilderFieldLocalization as ac, WebsiteBuilderInterfaceLocaleOption as ad, WebsiteBuilderMergeConflict as ae, WebsiteBuilderMergeDiffItem as af, WebsiteBuilderMergeResolutionStrategy as ag, WebsiteBuilderPageSettingsPanelProps as ah, WebsiteBuilderRevisionChangeSummaryItem as ai, WebsiteBuilderSearchInput as aj, WebsiteBuilderSiteColorSchemeDefinition as ak, WebsiteBuilderSiteDesignAppearance as al, WebsiteBuilderSiteDesignColorTokens as am, WebsiteBuilderSiteDesignPresetDefinition as an, WebsiteBuilderSiteDesignValue as ao, WebsiteBuilderSiteFrameActionKind as ap, WebsiteBuilderSiteSettingsPanelProps as aq, WebsiteBuilderDocument as b, WebsiteBuilderDocumentsMap as c, WebsiteBuilderFieldBinding as d, WebsiteBuilderLocaleDescriptor as e, WebsiteBuilderLocaleStatus as f, WebsiteBuilderMediaUploadInput as g, WebsiteBuilderMediaValue as h, WebsiteBuilderPageCatalogItem as i, WebsiteBuilderPageRuntimeData as j, WebsiteBuilderPageSettings as k, WebsiteBuilderResolvedPage as l, WebsiteBuilderResources as m, WebsiteBuilderSearchHighlight as n, WebsiteBuilderSearchResult as o, WebsiteBuilderSite as p, WebsiteBuilderSiteRegion as q, WebsiteBuilderSiteSettings as r, WebsiteBuilderWorkspaceCapabilities as s, WebsiteBuilderWorkspaceDescriptor as t, WebsiteBuilderSiteFrameExtension as u, WebsiteBuilderSiteFrameNavigationColumn as v, WebsiteBuilderSiteFrameLinkItem as w, WebsiteBuilderSiteFrameActionItem as x, WebsiteBuilderAccountTabExtension as y, WebsiteBuilderSurfaceMode as z };
