...
var richTextToolbarButtonClassName = (isActive) => clsx(
  ...
  isActive ? "border-[color:var(--photon-builder-border-strong)] bg-[color:var(--photon-builder-accent-soft)] text-[color:var(--photon-builder-accent-text)]" : "border-[color:var(--photon-builder-border)] bg-[color:var(--photon-builder-field)] text-[color:var(--photon-builder-text-soft)] hover:border-[color:var(--photon-builder-border-strong)] hover:text-[color:var(--photon-builder-text)]"
);
var renderPhotonRichTextHtml = (value, placeholder = PHOTON_EMPTY_TEXT) => {
  if (value.trim()) {
    return normalizeRichTextValue(value);
  }
  return `<p>${escapeRichTextHtml(placeholder)}</p>`;
};
var PhotonRichTextEditor = ({
  value,
  onChange,
  onFocus,
  onBlur,
