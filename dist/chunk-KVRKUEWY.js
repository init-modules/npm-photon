...
var PHOTON_SEARCH_CONDITION_IDS = {
...
var photonSystemConditionDefinitions = [
  {
...
var photonSystemInteractionPolicies = [
  {
...
var PhotonSiteSearch = ({
  ...
  if (previewMode === "builder-canvas-stage") {
    const renderText = (path, value, kind = "text", placeholderText, className2) => editableField ? editableField({ path, value, kind, placeholder: placeholderText, className: className2 }) : /* @__PURE__ */ jsx3("span", { className: className2, children: value || placeholderText || "" });
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx3("div", { className: "text-lg font-semibold text-[var(--photon-site-text)]", children: renderText("title", String(surfaceTitle ?? ""), "text", String(dialogTitle)) }),
              /* @__PURE__ */ jsx3("div", { className: "mt-2 text-sm leading-6 text-[var(--photon-site-muted-text)]", children: renderText("description", String(surfaceDescription ?? ""), "textarea", String(dialogDescription)) }),
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx3("div", { className: "flex-1", children: renderText("placeholder", String(surfacePlaceholder ?? ""), "text", String(placeholder)) })
                  ]
                }
              ),
              /* @__PURE__ */ jsx3("div", { className: "mt-3 text-xs leading-5 text-[var(--photon-site-muted-text)]", children: renderText("hint", String(surfaceHint ?? ""), "textarea", String(hintCopy)) }),
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    stageScenario === "loading" ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-sm text-[var(--photon-site-muted-text)]", children: [
                      /* @__PURE__ */ jsx3(Loader2, { className: "h-4 w-4 animate-spin" }),
                      renderText("loading", String(surfaceLoading ?? ""), "text", String(loadingCopy))
                    ] }) : null,
                    stageScenario === "empty" ? /* @__PURE__ */ jsx3("div", { className: "text-sm text-[var(--photon-site-muted-text)]", children: renderText("empty", String(surfaceEmpty ?? ""), "textarea", String(emptyCopy)) }) : null,
                    stageScenario === "error" ? /* @__PURE__ */ jsx3("div", { className: "text-sm text-[var(--photon-site-muted-text)]", children: translate(
                      "photon.search.error",
                      "Search is temporarily unavailable."
                    ) }) : null,
                    stageScenario === "results" ? /* @__PURE__ */ jsx3("div", { className: "space-y-2", children: mockResults.map((result) => /* @__PURE__ */ jsxs(
                      "div",
                      {
                        className: "rounded-[14px] border px-3 py-2 text-sm text-[var(--photon-site-text)]",
                        style: searchPanelStyle,
                        children: [
                          /* @__PURE__ */ jsxs("div", { className: "text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--photon-site-muted-text)]", children: [
                            result.pageGroup ? `${result.pageGroup} \xB7 ` : "",
                            result.pageName
                          ] }),
                          /* @__PURE__ */ jsx3("div", { children: result.snippet })
                        ]
                      },
                      result.id
                    )) }) : null,
                    stageScenario === "idle" ? /* @__PURE__ */ jsx3("div", { className: "text-sm text-[var(--photon-site-muted-text)]", children: translate(
                      "photon.search.idle",
