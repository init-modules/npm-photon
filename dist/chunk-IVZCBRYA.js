...
var EditableImage = ({
  ...
  ) : /* @__PURE__ */ jsx("div", { className: "flex h-full min-h-[14rem] w-full items-center justify-center bg-[color:var(--wb-site-surface)] text-center text-[color:var(--wb-site-muted)]", children: /* @__PURE__ */ jsx("div", { className: "px-6 text-sm leading-7", children: "Media" }) }) });
};
...
var WEBSITE_BUILDER_PUBLIC_SITE_DESIGN_TOKEN_KEYS = [
  "bodyFontFamily",
  "headingFontFamily",
  "backgroundColor",
  "surfaceColor",
...
var WEBSITE_BUILDER_PUBLIC_SITE_DESIGN_COLOR_TOKEN_KEYS = [
  "backgroundColor",
  "surfaceColor",
  "textColor",
  "mutedTextColor",
...
var WEBSITE_BUILDER_PUBLIC_SITE_DESIGN_DEFAULTS = {
...
var WEBSITE_BUILDER_PUBLIC_SITE_DESIGN_FALLBACK_DEFAULTS = {
...
var resolveWebsiteBuilderPublicSiteDesignSettings = (value) => {
  ...
  return {
    ...isFallbackDesign ? WEBSITE_BUILDER_PUBLIC_SITE_DESIGN_FALLBACK_DEFAULTS : WEBSITE_BUILDER_PUBLIC_SITE_DESIGN_DEFAULTS,
    ...tokenOverrides,
    componentVariants
  };
};
var isWebsiteBuilderPublicFramelessSiteDesign = (value) => {
  ...
  if (!canSearch) {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx3(Search, { className: "h-4 w-4 shrink-0 text-[var(--wb-site-muted)]" }),
          /* @__PURE__ */ jsx3(
            EditableText,
            {
              blockId,
...
var SiteFooterShell = ({
  ...
  return /* @__PURE__ */ jsx4(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxs2("div", { className: "mx-auto flex w-full max-w-[var(--wb-site-max-width,1280px)] flex-col gap-5 px-[var(--wb-site-gutter,24px)] py-8 pb-12 sm:py-10 sm:pb-14", children: [
          ...
          /* @__PURE__ */ jsx4(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs2("div", { className: "grid gap-5 lg:grid-cols-[auto_minmax(0,1fr)]", children: [
                /* @__PURE__ */ jsx4("div", { className: "relative h-24 w-24 overflow-hidden rounded-[28px] border border-[var(--wb-site-border)] bg-[linear-gradient(180deg,rgba(15,118,110,0.16),rgba(15,118,110,0.04))]", children: block.props.logoImage ? /* @__PURE__ */ jsx4(
                  EditableImage,
                  {
                    blockId: block.id,
                    path: "logoImage",
                ...
                ) : /* @__PURE__ */ jsx4("div", { className: "flex h-full items-center justify-center px-3 text-center text-[11px] font-semibold uppercase tracking-[0.3em] text-[var(--wb-site-accent)]", children: /* @__PURE__ */ jsx4(
                  EditableText,
                  {
                    blockId: block.id,
                    path: "brandTitle",
  ...
  const renderCartLink = (href, label, className, key) => /* @__PURE__ */ jsxs3(
    WebsiteBuilderLink,
    {
      ...
      children: [
        ...
        cartQuantity > 0 ? /* @__PURE__ */ jsx5("span", { className: "absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-[var(--wb-site-accent)] px-1 text-[10px] font-bold leading-none text-white", children: cartQuantity > 99 ? "99+" : cartQuantity }) : null
      ]
    },
    key ?? `cart:${href}`
  );
      ...
      children: /* @__PURE__ */ jsxs3(
        "div",
        {
          className: clsx5(
            ...
            ) : isShowcaseCard ? "mx-auto max-w-[calc(var(--wb-site-max-width,1280px)+var(--wb-site-gutter,24px)*2)] rounded-[calc(var(--wb-site-radius,24px)+10px)] border shadow-[0_28px_70px_rgba(15,23,42,0.08)]" : clsx5(
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxs3("div", { className: "flex flex-col gap-4", children: [
                  /* @__PURE__ */ jsxs3("div", { className: "flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between", children: [
                    /* @__PURE__ */ jsx5("div", { className: "flex flex-wrap items-center gap-3 text-sm text-[var(--wb-site-muted)]", children: utilityLinks.map(
                    ...
                    /* @__PURE__ */ jsxs3("div", { className: "flex flex-wrap items-center gap-3 text-sm", children: [
                      localeSwitcherVisible ? /* @__PURE__ */ jsxs3(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsx5("div", { className: "px-2 text-[10px] font-semibold uppercase tracking-[0.24em] text-[var(--wb-site-muted)]", children: translate(
                      ...
                      children: [
                        /* @__PURE__ */ jsxs3(
                          WebsiteBuilderLink,
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsx5("div", { className: "relative h-16 w-16 overflow-hidden rounded-[22px] border border-[var(--wb-site-border)] bg-[linear-gradient(180deg,rgba(15,118,110,0.14),rgba(15,118,110,0.03))]", children: block.props.logoImage ? /* @__PURE__ */ jsx5(
                                EditableImage,
                                {
                                  blockId: block.id,
                                  path: "logoImage",
                              ...
                              ) : /* @__PURE__ */ jsx5("div", { className: "flex h-full items-center justify-center px-3 text-center text-[11px] font-semibold uppercase tracking-[0.26em] text-[var(--wb-site-accent)]", children: /* @__PURE__ */ jsx5(
                                EditableText,
                                {
                                  blockId: block.id,
                                  path: "brandLabel",
                              ...
                              /* @__PURE__ */ jsxs3("div", { className: "min-w-0", children: [
                                ...
                                isShowcaseCard ? /* @__PURE__ */ jsx5("div", { className: "mt-1 text-xs uppercase tracking-[0.24em] text-[var(--wb-site-muted)]", children: "Live site frame" }) : null
                              ] })
                            ]
                          }
                        ),
                        commerceCatalogLink ? /* @__PURE__ */ jsxs3(
                          WebsiteBuilderLink,
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsx5("div", { className: "h-2.5 w-2.5 rounded-full bg-[var(--wb-site-accent)]" }),
                              /* @__PURE__ */ jsx5(
                                EditableText,
                                {
                                  blockId: block.id,
