...
var PhotonSurfaceLayoutContext = createContext(null);
var PhotonSurfaceLayoutProvider = ({
  children,
  value
}) => /* @__PURE__ */ jsx(PhotonSurfaceLayoutContext.Provider, { value, children });
var usePhotonSurfaceLayoutMetrics = () => useContext(PhotonSurfaceLayoutContext);
var usePhotonSurfaceBreakpoints = () => {
...
// src/search/photon-search-highlight-effect.tsx
import { useEffect } from "react";
var SEARCH_MARK_SELECTOR = 'mark[data-photon-search-mark="true"]';
var SEARCH_TARGET_SELECTOR = "[data-photon-search-target]";
var ACTIVE_TARGET_ATTRIBUTE = "data-photon-search-active-target";
...
var PhotonSearchHighlightEffect = ({
  activeHighlight
}) => {
  useEffect(() => {
    clearSearchMarks();
...
var resolveMobileMenuTriggerPlacement = (controls) => {
  const placement = controls?.menu?.triggerPlacement;
  if (placement === "fixed" || placement === "header" || placement === "hidden") {
    return placement;
  }
  return "fixed";
};
