...
var MediaStateChip = ({
  ...
  "div",
  {
    "data-testid": tone === "accent" ? "photon-media-state-chip-accent" : "photon-media-state-chip",
    className: clsx(
      "rounded-full border px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.22em]"
    ),
    style: tone === "accent" ? {
      borderColor: "var(--photon-gallery-chip-accent-border, rgba(34,211,238,0.16))",
      background: "var(--photon-gallery-chip-accent-bg, rgba(34,211,238,0.1))",
