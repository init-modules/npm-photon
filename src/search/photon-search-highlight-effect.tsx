...
import type { PhotonSearchHighlight } from "../types";
...
const SEARCH_MARK_SELECTOR = 'mark[data-photon-search-mark="true"]';
const SEARCH_TARGET_SELECTOR = "[data-photon-search-target]";
const ACTIVE_TARGET_ATTRIBUTE = "data-photon-search-active-target";
...
export const PhotonSearchHighlightEffect = ({
	activeHighlight,
}: PhotonSearchHighlightEffectProps) => {
	useEffect(() => {
		clearSearchMarks();
