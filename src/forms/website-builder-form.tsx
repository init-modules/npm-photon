...
import type {
	...
	WebsiteBuilderFormFieldRenderContext,
	WebsiteBuilderFormSubmitHandler,
...
const getFieldInputType = (field: WebsiteBuilderResolvedFormField) => {
	if (field.type === "phone") {
		return "tel";
	}
...
const getFieldWidthClassName = (field: WebsiteBuilderResolvedFormField) => {
