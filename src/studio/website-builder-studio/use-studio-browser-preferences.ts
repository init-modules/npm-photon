...
type UseStudioBrowserPreferencesInput = {
	...
	setMode: (mode: WebsiteBuilderMode) => void;
	draftStorageKey: string;
	hydrateModePreference: boolean;
	onManualSave: () => void;
};

const isPersistedMode = (value: string | null): value is WebsiteBuilderMode =>
...
export const loadStudioModePreference = async ({
	...
	const storedMode = await readStorage<WebsiteBuilderMode>(storageKey, {
