	...
	return (
		...
		>
			<div className="max-w-3xl">
				...
				<EditableText blockId={block.id} path="title" as="h2" />
				<EditableTextarea blockId={block.id} path="body" />
			</div>
			<div
			...
			>
				{areas.map((area, index) => {
					...
					return (
						...
						>
							{column.label?.trim() ? (
								<div className="mb-4 text-[11px] font-semibold uppercase tracking-[0.28em]">
									{column.label}
								</div>
							) : null}
...
export const websiteBuilderPublicSystemKit: WebsiteBuilderInstallableKit =
