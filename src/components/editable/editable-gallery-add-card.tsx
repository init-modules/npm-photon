	...
	return (
		<label
			...
			style={{
				...
				background:
					"var(--photon-gallery-add-bg, radial-gradient(circle_at_top_left,rgba(34,211,238,0.1),transparent_52%),linear-gradient(180deg,rgba(8,18,31,0.84),rgba(6,13,24,0.94)))",
		...
		>
			<div
				...
				style={{
					borderColor:
						"var(--photon-gallery-add-button-border, rgba(34,211,238,0.18))",
