...
```bash
pnpm add @init-modules/website-builder
```
...
Foundation runtime and editing primitives for the package-first website builder.

## Назначение

@init-modules/website-builder — npm/TypeScript package; Website Builder integration or runtime layer. Пакет экспортирует TypeScript/React primitives для frontend-части Init/Rx и не должен смешивать backend-интеграции с клиентским runtime.
...
~~~bash
npm install @init-modules/website-builder
~~~
...
- **context**: <code>context/external-state.test.ts</code>, <code>context/external-state.ts</code>, <code>context/website-builder-context.tsx</code>, <code>context/website-builder-render-depth-context.tsx</code>, <code>context/website-builder-store.test.ts</code>, <code>context/website-builder-store.ts</code>, <code>context/website-builder-surface-layout-context.tsx</code>
...
- **i18n**: <code>i18n/website-builder-i18n-context.tsx</code>, <code>i18n/website-builder-labels.ts</code>
...
- **search**: <code>search/constants.ts</code>, <code>search/helpers.ts</code>, <code>search/website-builder-search-highlight-effect.tsx</code>, <code>search/website-builder-site-search.tsx</code>
